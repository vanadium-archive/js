...
_typeWireAll.name = "v.io/core/veyron/lib/vdl/testdata/nativetest.WireAll";
...
_typeWireMapStringInt.name = "v.io/core/veyron/lib/vdl/testdata/nativetest.WireMapStringInt";
_typeWireMultiImport.kind = vdl.Kind.INT32;
_typeWireMultiImport.name = "v.io/core/veyron/lib/vdl/testdata/nativetest.WireMultiImport";
_typeWireSamePkg.kind = vdl.Kind.INT32;
_typeWireSamePkg.name = "v.io/core/veyron/lib/vdl/testdata/nativetest.WireSamePkg";
_typeWireString.kind = vdl.Kind.INT32;
_typeWireString.name = "v.io/core/veyron/lib/vdl/testdata/nativetest.WireString";
_typeWireTime.kind = vdl.Kind.INT32;
_typeWireTime.name = "v.io/core/veyron/lib/vdl/testdata/nativetest.WireTime";
_typeignoreme.kind = vdl.Kind.STRING;
_typeignoreme.name = "v.io/core/veyron/lib/vdl/testdata/nativetest.ignoreme";
_typeWireAll.freeze();
