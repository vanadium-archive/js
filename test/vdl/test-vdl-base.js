...
var base = require(
  '../vdl-out/v.io/v23/vdl/testdata/base');
...
test('named primitive types', function(assert) {
  ...
  assert.deepEqual(res._type, {
    kind: Kind.BOOL,
    name: 'v.io/v23/vdl/testdata/base.NamedBool',
  });
  ...
  assert.deepEqual(res._type,{
    kind: Kind.BYTE,
    name: 'v.io/v23/vdl/testdata/base.NamedByte',
  });
  ...
  assert.deepEqual(res._type, {
    kind: Kind.UINT16,
    name: 'v.io/v23/vdl/testdata/base.NamedUint16',
  });
  assert.equal(res.val, 1);
  ...
  assert.deepEqual(res._type, {
    kind: Kind.UINT32,
    name: 'v.io/v23/vdl/testdata/base.NamedUint32',
  });
  assert.equal(res.val, 1);
  ...
  assert.deepEqual(res._type, {
    kind: Kind.UINT64,
    name: 'v.io/v23/vdl/testdata/base.NamedUint64',
  });
  ...
  assert.deepEqual(res._type, {
    kind: Kind.INT16,
    name: 'v.io/v23/vdl/testdata/base.NamedInt16',
  });
  assert.equal(res.val, 1);
  ...
  assert.deepEqual(res._type, {
    kind: Kind.INT32,
    name: 'v.io/v23/vdl/testdata/base.NamedInt32',
  });
  assert.equal(res.val, 1);
  ...
  assert.deepEqual(res._type, {
    kind: Kind.INT64,
    name: 'v.io/v23/vdl/testdata/base.NamedInt64',
  });
  assert.deepEqual(res.val, BigInt.fromNativeNumber(1));
  ...
  assert.deepEqual(res._type, {
    kind: Kind.FLOAT32,
    name: 'v.io/v23/vdl/testdata/base.NamedFloat32',
  });
  assert.equal(res.val, 1);
  ...
  assert.deepEqual(res._type, {
    kind: Kind.FLOAT64,
    name: 'v.io/v23/vdl/testdata/base.NamedFloat64',
  });
  assert.equal(res.val, 1);
  ...
  assert.deepEqual(res._type, {
    kind: Kind.COMPLEX64,
    name: 'v.io/v23/vdl/testdata/base.NamedComplex64',
  });
  ...
  assert.deepEqual(res._type, {
    ...
    name: 'v.io/v23/vdl/testdata/base.NamedComplex128',
  });
  assert.deepEqual(res.val, { real: 0, imag: 0 });
  ...
  assert.deepEqual(res._type, {
    kind: Kind.STRING,
    name: 'v.io/v23/vdl/testdata/base.NamedString',
  });
...
test('named composite types', function(assert) {
  ...
  assert.deepEqual(res._type, {
    name: 'v.io/v23/vdl/testdata/base.NamedArray',
    kind: Kind.ARRAY,
    elem: Types.BOOL,
    len: 2,
  });
  ...
  assert.deepEqual(res._type, {
    name: 'v.io/v23/vdl/testdata/base.NamedList',
    kind: Kind.LIST,
    elem: Types.UINT32
  });
