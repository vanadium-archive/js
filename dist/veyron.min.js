...
function toStandardErrorStruct(r){var o={id:"unknown",action:0},t="";return r instanceof Error?(t=r.message,r.idAction&&(o=r.idAction)):void 0!==r&&null!==r&&(t=r+""),new _standard(o,t)}function toJSerror(r){var o,t=r.iDAction.iD||r.iDAction.id,n=errIdConstrMap[t],d=r.msg||t+": "+r.paramList.join(" ");return o=n?new n(d):new vError.VeyronError(d,r.iDAction)}var vError=require("./../lib/verror");module.exports={toStandardErrorStruct:toStandardErrorStruct,toJSerror:toJSerror};var _standard=function(r,o){this.idAction=r,this.msg=o},errIdConstrMap={};errIdConstrMap[vError.IdActions.Aborted.id]=vError.AbortedError,errIdConstrMap[vError.IdActions.BadArg.id]=vError.BadArgError,errIdConstrMap[vError.IdActions.BadProtocol.id]=vError.BadProtocolError,errIdConstrMap[vError.IdActions.Exists.id]=vError.ExistsError,errIdConstrMap[vError.IdActions.Internal.id]=vError.InternalError,errIdConstrMap[vError.IdActions.NoAccess.id]=vError.NoAccessError,errIdConstrMap[vError.IdActions.NoExist.id]=vError.NoExistError,errIdConstrMap[vError.IdActions.NoExistOrNoAccess.id]=vError.NoExistOrNoAccessError;
...
function authorizer(r){return function(e){if(e.localId&&e.remoteId&&e.localId.publicKey===e.remoteId.publicKey)return null;for(var n=e.remoteId.Names(),t=0;t<n.length;t++)if(matchesACL(n[t],e.label,r))return null;return errACL}}function matchesACL(r,e,n){var t,o,a={},i=0;for(t in n.in)if(n.hasOwnProperty(t)&&(o=n.in[t],nameMatches(r,t)))for(i=0;i<o.length;i++)a[o[i]]=!0;if(!a[e])return!1;for(t in n.notIn)if(n.hasOwnProperty(t)&&(t.lastIndexOf("...")===t.length-4&&(t=t.substr(0,t.length-3)),o=n.notIn[t],nameMatches(r,t))){for(i=0;i<o.length;i++)a[o[i]]=!1;if(!a[e])return!1}return!0}var nameMatches=require("./name_matching"),vError=require("./../lib/verror");module.exports=authorizer;var errACL=new vError.NoAccessError("acl authorization failed");
},{"./../lib/verror":70,"./name_matching":85}],83:[function(require,module,exports){
function MethodCaveat(e){this._methods=e}function PeerBlessingsCaveat(e){this._patterns=e}module.exports={MethodCaveat:MethodCaveat,PeerBlessingsCaveat:PeerBlessingsCaveat},MethodCaveat.prototype.toJSON=function(){return{_type:"MethodCaveat",data:this._methods}},PeerBlessingsCaveat.prototype.toJSON=function(){return{_type:"PeerBlessingsCaveat",data:this._patterns}};
...
},{"./public.js":87}],85:[function(require,module,exports){
function nameMatches(e,t){for(var n=e.split("/"),r=t.split("/"),l=0;l<r.length;l++){if("*"===r[l])return l===r.length-1;if(l===n.length)return!0;if(n[l]!==r[l])return!1}return n.length===r.length}module.exports=nameMatches;
...
function PublicId(t,e,i,s){this.names=t,this._id=e,this._count=1,this._proxy=s,this._key=i}var MessageType=require("../proxy/message_type"),nameMatches=require("./name_matching");PublicId.prototype.match=function(t){if(""===t||!t)return!1;for(var e=0;e<this.names.length;e++)if(nameMatches(this.names[e],t))return!0;return!1},PublicId.prototype.retain=function(){this._count++},PublicId.prototype.release=function(){if(this._count--,0===this._count){var t=JSON.stringify(this._id);this._proxy.sendRequest(t,MessageType.UNLINK_ID,null,this._proxy.nextId())}},PublicId.prototype.toJSON=function(){return{id:this._id,names:this.names,key:this._key}},module.exports=PublicId;
},{"../proxy/message_type":76,"./name_matching":85}],88:[function(require,module,exports){
(function (process){
function init(e,r){"function"==typeof e&&(r=e,e={}),e=extend(defaults,e);var t=new Deferred(r),i={wspr:e.wspr||process.env.WSPR||"http://localhost:8124"};return e.authenticate?getIdentity(e.authTimeout,function(e,r){return e?(t.reject(e),t.promise):(i.identityName=r,void t.resolve(new Runtime(i)))}):(i.identityName="unknown",t.resolve(new Runtime(i))),t.promise}function getIdentity(e,r){function t(e){u(),r(null,e.name)}function i(e){u(),r(e)}function n(){window.clearInterval(a)}function o(){i(new Error("Auth timeout. Please ensure that the Veyron Chrome Extension is installed and enabled. Download it here: https://github.com/veyron/veyron.js/raw/master/extension/veyron.crx"))}function u(){window.clearInterval(a),window.clearTimeout(s),c.removeListener("auth:success",t),c.removeListener("auth:error",i)}if(!isBrowser)return r(new Error("authenticate=true requires browser environment"));var s,a,l=require("postie"),c=new l(window);c.on("auth:success",t),c.on("auth:error",i),c.on("auth:received",n),a=window.setInterval(function(){c.post("auth")},200),s=window.setTimeout(o,e)}var extend=require("xtend"),isBrowser=require("is-browser"),Deferred=require("./lib/deferred"),Runtime=require("./runtime/runtime"),vlog=require("./lib/vlog"),defaults={logLevel:vlog.level,authenticate:!1,authTimeout:5e3};module.exports={errors:require("./lib/verror"),init:init,logLevels:require("./lib/vlog").levels,namespaceUtil:require("./namespace/util"),Promise:require("./lib/promise"),createLeafDispatcher:require("./ipc/leaf_dispatcher"),vom:{Kind:require("./vom/kind"),Types:require("./vom/types")},caveats:require("./security/caveat"),aclAuthorizer:require("./security/acl_authorizer")};
}).call(this,require("FWaASH"))
},{"./ipc/leaf_dispatcher":65,"./lib/deferred":68,"./lib/promise":69,"./lib/verror":70,"./lib/vlog":71,"./namespace/util":73,"./runtime/runtime":81,"./security/acl_authorizer":82,"./security/caveat":83,"./vom/kind":89,"./vom/types":90,"FWaASH":42,"is-browser":59,"postie":60,"xtend":62}],89:[function(require,module,exports){
