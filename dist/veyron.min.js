...
(function (process){
function init(e,t){"function"==typeof e&&(t=e,e={}),e=e||{},vlog.level=e.logLevel||vlog.level,e.authTimeout=e.authTimeout||5e3;var n=new Deferred(t),r={wspr:e.wspr||process.env.WSPR||"http://localhost:8124"},i="object"==typeof window;return i&&!e.skipAuthentication?getIdentity(e.authTimeout,function(e,t){return e?(n.reject(e),n.promise):(r.identityName=t,void n.resolve(new Runtime(r)))}):(r.identityName="unknown",n.resolve(new Runtime(r))),n.promise}function getIdentity(e,t){function n(){window.clearInterval(v),window.clearTimeout(m)}function r(e){l(),t(null,e.name)}function i(e){l(),t(e)}function o(){n()}function u(){i(new Error("Auth timeout. Please ensure that the Veyron Chrome Extension is installed and enabled. Download it here: https://github.com/veyron/veyron.js/raw/master/extension/veyron.crx"))}function l(){n(),c.removeListener("auth:success",r),c.removeListener("auth:error",i)}var s="object"==typeof window;if(!s)return process.nextTick(t.bind(null,null));var a=require("postie"),c=new a(window);c.on("auth:success",r),c.on("auth:error",i),c.on("auth:received",o);var v=window.setInterval(function(){c.post("auth")},200),m=setTimeout(u,e)}var Runtime=require("./runtime/runtime"),Deferred=require("./lib/deferred"),vlog=require("./lib/vlog");module.exports={init:init,logLevels:require("./lib/vlog").levels,namespaceUtil:require("./namespace/util"),errors:require("./lib/verror")};
}).call(this,require("FWaASH"))
