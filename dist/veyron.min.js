...
var Promise=require("es6-promise").Promise,Deferred=function(e){var r=this;this.promise=new Promise(function(e,i){r.resolve=e,r.reject=i}),e&&this.promise.then(function(r){e(null,r)},function(r){e(r)})};module.exports=Deferred;
...
function Runtime(e){return this instanceof Runtime?(e.wspr=e.wspr||"vonery.com:8125",("undefined"==typeof e.logLevel||null===e.logLevel)&&(e.logLevel=vLog.levels.DEBUG),this._config=e,void(vLog.level=e.logLevel)):new Runtime(e)}var Promise=require("es6-promise").Promise,Server=require("../ipc/server"),ServerRouter=require("../ipc/server_router"),Client=require("../ipc/client"),ProxyConnection=require("../proxy/websocket"),Namespace=require("../namespace/namespace"),store=require("../storage/store"),vLog=require("../lib/vlog");module.exports=Runtime,Runtime.prototype.bindTo=function(e,t,r){var n=this._getClient();return n.bindTo(e,t,r)},Runtime.prototype.serve=function(e,t,r,n){var o=this._getServer();return o.serve(e,t,r,n)},Runtime.prototype.addIDL=function(e){var t=this._getServer();return t.addIDL(e)},Runtime.prototype._getProxyConnection=function(){return this._proxyConnection||(this._proxyConnection=new ProxyConnection(this._config.wspr)),this._proxyConnection},Runtime.prototype._getRouter=function(){return this._router||(this._router=new ServerRouter(this._getProxyConnection())),this._router},Runtime.prototype._getClient=function(){return this._client=this._client||new Client(this._getProxyConnection()),this._client},Runtime.prototype._getServer=function(){return this._server=this._server||new Server(this._getRouter()),this._server},Runtime.prototype.newStore=function(){return new store.Store(this._getClient())},Runtime.prototype.newNamespace=function(e){var t=this,r=this._getProxyConnection();return e?Promise.resolve(new Namespace(this._getClient(),e)):(r.getWebSocket(),r.config.then(function(e){return new Namespace(t._getClient(),e.mounttableRoot)}))};
