...
function Deferred(e){function r(r){e(null,r)}function o(r){e(r)}var i=this;i.promise=new Promise(function(e,r){i.resolve=e,i.reject=r}),e&&i.promise.then(r,o)}var Promise=require("./promise");module.exports=Deferred;
...
(function (process){
function init(e,t){"function"==typeof e&&(t=e,e={}),e=extend(defaults,e);var r=new Deferred(t),n={wspr:e.wspr||process.env.WSPR||"http://localhost:8124"};return isBrowser&&e.authenticate?getIdentity(e.authTimeout,function(e,t){return e?(r.reject(e),r.promise):(n.identityName=t,void r.resolve(new Runtime(n)))}):(n.identityName="unknown",r.resolve(new Runtime(n))),r.promise}function getIdentity(e,t){function r(){window.clearInterval(c),window.clearTimeout(v)}function n(e){s(),t(null,e.name)}function i(e){s(),t(e)}function o(){r()}function u(){i(new Error("Auth timeout. Please ensure that the Veyron Chrome Extension is installed and enabled. Download it here: https://github.com/veyron/veyron.js/raw/master/extension/veyron.crx"))}function s(){r(),l.removeListener("auth:success",n),l.removeListener("auth:error",i)}var a=require("postie"),l=new a(window);l.on("auth:success",n),l.on("auth:error",i),l.on("auth:received",o);var c=window.setInterval(function(){l.post("auth")},200),v=setTimeout(u,e)}var Runtime=require("./runtime/runtime"),Deferred=require("./lib/deferred"),vlog=require("./lib/vlog"),extend=require("xtend"),isBrowser=require("is-browser"),defaults={logLevel:vlog.level,authenticate:!1,authTimeout:5e3};module.exports={init:init,logLevels:require("./lib/vlog").levels,namespaceUtil:require("./namespace/util"),errors:require("./lib/verror")};
}).call(this,require("FWaASH"))
},{"./lib/deferred":67,"./lib/verror":69,"./lib/vlog":70,"./namespace/util":73,"./runtime/runtime":81,"FWaASH":42,"is-browser":59,"postie":60,"xtend":62}]},{},[84])
