...
},{"./../idl/idl":63}],66:[function(require,module,exports){
...
},{"./promise":69}],69:[function(require,module,exports){
module.exports=require("bluebird");
},{"bluebird":3}],70:[function(require,module,exports){
...
},{"util":58}],71:[function(require,module,exports){
...
},{"xtend":62}],72:[function(require,module,exports){
function convertServersToStrings(e){for(var r=e[0],o=e[1],t=[],a=0;a<r.length;a++){var n=r[a].server;""!==o&&(n=nameUtil.join(n,o)),t.push(n)}return t}function makeAllTerminal(e){return e.map(nameUtil.convertToTerminalName)}function allAreTerminal(e){return e.every(nameUtil.isTerminal)}function errorEquals(e,r){var o=e.name===r.name&&-1!==e.message.indexOf(r.message,e.message.length-r.message.length);return o}var nameUtil=require("./util.js"),Promise=require("../lib/promise"),Deferred=require("../lib/deferred"),vError=require("../lib/verror"),Namespace=function(e,r){this._client=e,this._roots=r};Namespace.errNotAMountTable=function(){return new vError.AbortedError("Resolution target is not a mount table")},Namespace.errNoSuchName=function(){return new vError.NoExistError("Name doesn't exist")},Namespace.errNoSuchNameRoot=function(){return new vError.NoExistError("Name doesn't exist: root of namespace")},Namespace._maxDepth=32,Namespace.prototype._rootNames=function(e){if(nameUtil.isRooted(e)&&"/"!==e)return[e];for(var r=[],o=0;o<this._roots.length;o++)r.push(nameUtil.join(this._roots[o],e));return r},Namespace.prototype._resolveAgainstMountTable=function(e){if(0===e.length)return Promise.reject(new vError.BadArgError("No servers to resolve query."));var r=this,o=nameUtil.convertToTerminalName(e[0]);return this._client.bindTo(o).then(function(e){if(void 0===e.resolveStep)throw Namespace.errNotAMountTable();return e.resolveStep().then(convertServersToStrings)}).catch(function(o){if(errorEquals(o,Namespace.errNoSuchName())||errorEquals(o,Namespace.errNoSuchNameRoot())||e.length<=1)throw o;return r._resolveAgainstMountTable(e.slice(1))})},Namespace.prototype._resolveLoop=function(e,r,o,t){var a=this;return a._resolveAgainstMountTable(e).then(function(r){if(allAreTerminal(r))return r;if(o++,o>Namespace._maxDepth)throw new vError.InternalError("Maxiumum resolution depth exceeded.");return a._resolveLoop(r,e,o,t)},function(o){return t(o,e,r)})},Namespace.prototype.resolveToMountTable=function(e,r){var o=this._rootNames(e),t=new Deferred(r),a=function(e,r,o){if(errorEquals(e,Namespace.errNoSuchNameRoot())||errorEquals(e,Namespace.errNotAMountTable()))return makeAllTerminal(o);if(errorEquals(e,Namespace.errNoSuchName()))return makeAllTerminal(r);throw e};return t.resolve(this._resolveLoop(o,o,0,a)),t.promise},Namespace.prototype.resolveMaximally=function(e,r){var o=this._rootNames(e),t=new Deferred(r),a=function(e,r){if(errorEquals(e,Namespace.errNoSuchNameRoot())||errorEquals(e,Namespace.errNoSuchName())||errorEquals(e,Namespace.errNotAMountTable()))return makeAllTerminal(r);throw e};return t.resolve(this._resolveLoop(o,o,0,a)),t.promise},module.exports=Namespace;
},{"../lib/deferred":68,"../lib/promise":69,"../lib/verror":70,"./util.js":74}],73:[function(require,module,exports){
...
},{"../lib/deferred":68,"../proxy/message_type":77,"../proxy/stream":80,"../proxy/stream_handler":81}],74:[function(require,module,exports){
...
},{"./../lib/verror":70}],76:[function(require,module,exports){
var IncomingPayloadType={FINAL_RESPONSE:0,STREAM_RESPONSE:1,ERROR_RESPONSE:2,INVOKE_REQUEST:3,STREAM_CLOSE:4,LOOKUP_REQUEST:5,AUTHORIZATION_REQUEST:6};module.exports=IncomingPayloadType;
},{}],77:[function(require,module,exports){
var MessageType={REQUEST:0,SERVE:1,RESPONSE:2,STREAM_VALUE:3,STREAM_CLOSE:4,SIGNATURE:5,STOP:6,BLESS:8,UNLINK_ID:9,NEW_ID:10,LOOKUP_RESPONSE:11,AUTHORIZATION_RESPONSE:12,NAMESPACE_REQUEST:13};module.exports=MessageType;
},{}],78:[function(require,module,exports){
function Proxy(e){this.id=1,this.outstandingRequests={},this.bindCache={},this._hasResolvedConfig=!1,this._configDeferred=new Deferred,this.config=this._configDeferred.promise,this.senderPromise=e,this.incomingRequestHandlers={}}var MessageType=require("./message_type"),IncomingPayloadType=require("./incoming_payload_type"),Deferred=require("./../lib/deferred"),vLog=require("./../lib/vlog"),SimpleHandler=require("./simple_handler"),BIND_CACHE_TTL=36e5;Proxy.prototype.process=function(e){if(this._hasResolvedConfig===!1)return this._hasResolvedConfig=!0,void this._configDeferred.resolve(e);var n,t=e.id%2===0,i=this.outstandingRequests[e.id];try{n=JSON.parse(e.data)}catch(s){return void(t||i.handleResponse(IncomingPayloadType.ERROR_RESPONSE,e.data))}if(!t&&!i)return void vLog.warn("Dropping message for unknown flow "+e.id+" "+e.data);if(i)i.handleResponse(n.type,n.message);else{if(i=this.incomingRequestHandlers[n.type],!i)return void vLog.warn("Dropping message for unknown invoke payload "+n.type);i.handleRequest(e.id,n.type,n.message)}},Proxy.prototype.dequeue=function(e){delete this.outstandingRequests[e]},Proxy.prototype.nextId=function(){var e=this.id;return this.id+=2,e},Proxy.prototype.getServiceSignature=function(e){var n=this,t=new Deferred,i=Date.now,s=this.bindCache[e];if(s&&i()-s.fetched<BIND_CACHE_TTL)return t.resolve(s.signature),t.promise;t.promise.then(function(t){n.bindCache[e]={signature:t,fetched:i()}});var o={name:e},r=JSON.stringify(o),d=n.nextId(),a=new SimpleHandler(t,n,d);return n.sendRequest(r,MessageType.SIGNATURE,a,d),t.promise},Proxy.prototype.addIncomingHandler=function(e,n){this.incomingRequestHandlers[e]=n},Proxy.prototype.addIncomingStreamHandler=function(e,n){this.outstandingRequests[e]=n},Proxy.prototype.sendRequest=function(e,n,t,i){t&&(this.outstandingRequests[i]=t);var s=JSON.stringify({id:i,data:e,type:n}),o=this;this.senderPromise.then(function(e){e.send(s)}).catch(function(e){var n=o.outstandingRequests[i];n&&(n.handleResponse(IncomingPayloadType.ERROR_RESPONSE,e),delete o.outstandingRequests[i])})},module.exports=Proxy;
},{"./../lib/deferred":68,"./../lib/vlog":71,"./incoming_payload_type":76,"./message_type":77,"./simple_handler":79}],79:[function(require,module,exports){
...
},{"./../lib/verror":70,"./error_conversion":75,"./incoming_payload_type":76}],80:[function(require,module,exports){
...
},{"./message_type":77,"stream":56,"util":58}],81:[function(require,module,exports){
...
},{"./error_conversion":75,"./incoming_payload_type":76}],82:[function(require,module,exports){
...
},{"./../lib/deferred":68,"./../lib/vlog":71,"./proxy":78,"is-browser":59,"ws":61}],83:[function(require,module,exports){
function Runtime(e){return this instanceof Runtime?(this.identityName=e.identityName,this._wspr=e.wspr,this.identity=new PrivateId(this._getProxyConnection()),void(this._name=e.appName)):new Runtime(e)}var Server=require("../ipc/server"),ServerRouter=require("../ipc/server_router"),Client=require("../ipc/client"),ProxyConnection=require("../proxy/websocket"),MessageType=require("../proxy/message_type"),Namespace=require("../namespace/namespace"),Namespace2=require("../namespace/namespace2"),PrivateId=require("../security/private"),PublicId=require("../security/public"),Promise=require("../lib/promise"),Deferred=require("../lib/deferred"),SimpleHandler=require("../proxy/simple_handler");module.exports=Runtime,Runtime.prototype.bindTo=function(e,t,r){var n=this,i=this._getClient();return"function"==typeof t&&(r=t,t=void 0),r&&(r=r.bind(n)),i.bindTo(e,t,r)},Runtime.prototype.close=function(e){var t=this;return t._getProxyConnection().close(e)},Runtime.prototype.serve=function(e,t,r,n){var i=this._getServer();return i.serve(e,t,r,n)},Runtime.prototype.addIDL=function(e){var t=this._getServer();return t.addIDL(e)},Runtime.prototype._getProxyConnection=function(){return this._proxyConnection||(this._proxyConnection=new ProxyConnection(this._wspr)),this._proxyConnection},Runtime.prototype._getRouter=function(){return this._router||(this._router=new ServerRouter(this._getProxyConnection(),this._name)),this._router},Runtime.prototype._getClient=function(){return this._client=this._client||new Client(this._getProxyConnection()),this._client},Runtime.prototype._getServer=function(){return this._server=this._server||new Server(this._getRouter()),this._server},Runtime.prototype.newNamespace=function(e){var t=this,r=this._getProxyConnection();return e?Promise.resolve(new Namespace(this._getClient(),e)):(r.getWebSocket(),r.config.then(function(e){return new Namespace(t._getClient(),e.mounttableRoot)}))},Runtime.prototype.newNamespace2=function(e){var t=this._getProxyConnection();return new Namespace2(t,e)},Runtime.prototype.newIdentity=function(e,t){var r=new Deferred(t),n=new Deferred,i=this._getProxyConnection(),o=i.nextId(),s=new SimpleHandler(n,i,o);return i.sendRequest(JSON.stringify(e),MessageType.NEW_ID,s,o),n.promise.then(function(e){var t=new PublicId(e.names,e.handle,e.publicKey,i);r.resolve(t)},r.reject),r.promise};
},{"../ipc/client":64,"../ipc/server":66,"../ipc/server_router":67,"../lib/deferred":68,"../lib/promise":69,"../namespace/namespace":72,"../namespace/namespace2":73,"../proxy/message_type":77,"../proxy/simple_handler":79,"../proxy/websocket":82,"../security/private":88,"../security/public":89}],84:[function(require,module,exports){
...
},{"./../lib/verror":70,"./blessing_matching":85}],85:[function(require,module,exports){
...
},{"./public.js":89}],88:[function(require,module,exports){
...
},{"../lib/deferred":68,"../proxy/message_type":77,"../proxy/simple_handler":79,"./public":89}],89:[function(require,module,exports){
...
},{"../proxy/message_type":77,"./blessing_matching":85}],90:[function(require,module,exports){
(function (process){
<<<<<<< HEAD
function init(e,r){"function"==typeof e&&(r=e,e={}),e=extend(defaults,e);var t=new Deferred(r),i={wspr:e.wspr||process.env.WSPR||"http://localhost:8124",appName:e.appName||"webapp"};return e.authenticate?getIdentity(e.authTimeout,function(e,r){return e?(t.reject(e),t.promise):(i.identityName=r,void t.resolve(new Runtime(i)))}):(i.identityName="unknown",t.resolve(new Runtime(i))),t.promise}function getIdentity(e,r){function t(e){u(),r(null,e.name)}function i(e){u(),r(objectToError(e.error))}function n(){window.clearInterval(s)}function o(){i({error:new Error("Auth timeout. Please ensure that the Veyron Chrome Extension is installed and enabled. Download it here: https://github.com/veyron/veyron.js/raw/master/extension/veyron.crx")})}function u(){window.clearInterval(s),window.clearTimeout(a),l.removeListener("auth:success",t),l.removeListener("auth:error",i)}if(!isBrowser)return r(new Error("authenticate=true requires browser environment"));var a,s,c=require("postie"),l=new c(window);l.on("auth:success",t),l.on("auth:error",i),l.on("auth:received",n),s=window.setInterval(function(){l.post("auth")},200),a=window.setTimeout(o,e)}function objectToError(e){var r=new Error(e.message);return r.name=e.name,r.stack=e.stack,r}var extend=require("xtend"),isBrowser=require("is-browser"),Deferred=require("./lib/deferred"),Runtime=require("./runtime/runtime"),vlog=require("./lib/vlog"),defaults={logLevel:vlog.level,authenticate:!1,authTimeout:5e3};module.exports={errors:require("./lib/verror"),init:init,logLevels:require("./lib/vlog").levels,namespaceUtil:require("./namespace/util"),Promise:require("./lib/promise"),createLeafDispatcher:require("./ipc/leaf_dispatcher"),vom:{Kind:require("./vom/kind"),Types:require("./vom/types")},caveats:require("./security/caveat"),aclAuthorizer:require("./security/acl_authorizer")};
=======
...
>>>>>>> 24846fdc7b83ab69e80a8000fabcfd6bcb371f14
}).call(this,require("FWaASH"))
},{"./ipc/leaf_dispatcher":65,"./lib/deferred":68,"./lib/promise":69,"./lib/verror":70,"./lib/vlog":71,"./namespace/util":74,"./runtime/runtime":83,"./security/acl_authorizer":84,"./security/caveat":86,"FWaASH":42,"is-browser":59,"postie":60,"xtend":62}]},{},[90])
