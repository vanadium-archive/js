...
function ProxyConnection(e){this.url=e.replace(/^(http|https)/,"ws")+"/ws",this.currentWebSocketPromise=null;var r=new Deferred;Proxy.call(this,r.promise),r.resolve(this.getWebSocket())}var WebSocket=require("ws"),Deferred=require("./../lib/deferred"),vLog=require("./../lib/vlog"),Proxy=require("./proxy"),isBrowser=require("is-browser");ProxyConnection.prototype=Object.create(Proxy.prototype),ProxyConnection.prototype.constructor=ProxyConnection,ProxyConnection.prototype.getWebSocket=function(){if(this.currentWebSocketPromise)return this.currentWebSocketPromise;var e=new WebSocket(this.url),r=this,o=new Deferred;this.currentWebSocketPromise=o.promise,e.onopen=function(){vLog.info("Connected to proxy at",r.url),o.resolve(e)};var t=this._configDeferred;return e.onerror=function(e){vLog.error("Failed to connect to proxy at url:",r.url);var n=isBrowser&&!!window.Event&&e instanceof window.Event,i=n&&"error"===e.type;i&&(e=new Error("WebSocket error - "+r.url)),o.reject(e);var c="Proxy connection closed, failed to get config "+e.message;t.reject(new Error(c))},e.onmessage=function(e){var o;try{o=JSON.parse(e.data)}catch(t){return void vLog.warn("Failed to parse "+e.data)}r.process(o)},o.promise},ProxyConnection.prototype.close=function(e){function r(e){e.onclose=t.resolve,e.close()}var o=this,t=new Deferred(e);return o.getWebSocket().then(r,function(){t.resolve()}),t.promise},module.exports=ProxyConnection;
