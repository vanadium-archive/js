...
function Namespace(e,r){this._proxy=e,this._roots=r}function createMessage(e,r,s){var t={method:e,args:s||null,roots:r||[]};return JSON.stringify(t)}var Deferred=require("../lib/deferred"),MessageType=require("../proxy/message_type"),Stream=require("../proxy/stream"),StreamHandler=require("../proxy/stream_handler");module.exports=Namespace;var NamespaceMethods={GLOB:0};Namespace.prototype.glob=function(e,r){var s=new Deferred(r),t=this._proxy.nextId();s.stream=new Stream(t,this._proxy.senderPromise,!0);var a=new StreamHandler(s.stream),o={pattern:e},n=createMessage(NamespaceMethods.GLOB,this._roots,o);return this._proxy.sendRequest(n,MessageType.NAMESPACE_REQUEST,null,t),this._proxy.addIncomingStreamHandler(t,a),s.promise.stream=s.stream,s.promise},Namespace.prototype.setRoots=function(e){Array.isArray(e)||(e=Array.prototype.slice.call(arguments)),this._roots=e};
},{"../lib/deferred":70,"../proxy/message_type":78,"../proxy/stream":81,"../proxy/stream_handler":82}],75:[function(require,module,exports){
