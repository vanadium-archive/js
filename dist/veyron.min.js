...
function ServerContext(t,e){return this instanceof ServerContext?(this._ctx=new context.Context({}),this._ctx=t.context.timeout!==constants.NO_TIMEOUT?this._ctx.withTimeout(t.context.timeout):this._ctx.withCancel(),this.suffix=t.context.suffix,this.name=t.context.name,void(this.remoteId=new PublicId(t.context.remoteID.names,t.context.remoteID.handle,t.context.remoteID.publicKey,e))):new ServerContext}var PublicId=require("../security/public"),context=require("../runtime/context"),inherits=require("util").inherits,constants=require("./constants");module.exports=ServerContext,inherits(ServerContext,context.Context),ServerContext.prototype.deadline=function(){return this._ctx.deadline()},ServerContext.prototype.done=function(){return this._ctx.done()},ServerContext.prototype.waitUntilDone=function(t){return this._ctx.waitUntilDone(t)},ServerContext.prototype.runtime=function(){return this._ctx.runtime()},ServerContext.prototype.value=function(){return this._ctx.value()},ServerContext.prototype.cancel=function(){return this._ctx.cancel()};
},{"../runtime/context":84,"../security/public":91,"./constants":65,"util":58}],69:[function(require,module,exports){
var Promise=require("../lib/promise"),Stream=require("../proxy/stream"),MessageType=require("../proxy/message_type"),IncomingPayloadType=require("../proxy/incoming_payload_type"),ErrorConversion=require("../proxy/error_conversion"),Deferred=require("./../lib/deferred"),vLog=require("./../lib/vlog"),SimpleHandler=require("../proxy/simple_handler"),StreamHandler=require("../proxy/stream_handler"),vError=require("../lib/verror"),IdlHelper=require("./../idl/idl"),SecurityContext=require("../security/context"),ServerContext=require("./server_context"),Router=function(e,r){this._servers={},this._proxy=e,this._streamMap={},this._contextMap={},this._appName=r,e.addIncomingHandler(IncomingPayloadType.INVOKE_REQUEST,this),e.addIncomingHandler(IncomingPayloadType.LOOKUP_REQUEST,this),e.addIncomingHandler(IncomingPayloadType.AUTHORIZATION_REQUEST,this),e.addIncomingHandler(IncomingPayloadType.CANCEL,this)},inject=function(e,r,t){var n=Object.keys(r),o={};n.forEach(function(e){o[r[e]]=e});var i=n.map(function(e){return r[e]});i.filter(function(e){return void 0!==e}),i.sort();var s=[];return i.forEach(function(r){var n=o[r];e.splice(r,0,t[n]),s.push(n)}),s};Router.prototype.invokeMethod=function(e,r,t){try{return r.apply(e,t)}catch(n){if(!(n instanceof Error)){var o;return o="undefined"==typeof n||null===n?"Unknown exception.":JSON.stringify(n),new Error(o)}return n}},Router.prototype.handleRequest=function(e,r,t){switch(r){case IncomingPayloadType.INVOKE_REQUEST:this.handleRPCRequest(e,t);break;case IncomingPayloadType.LOOKUP_REQUEST:this.handleLookupRequest(e,t);break;case IncomingPayloadType.AUTHORIZATION_REQUEST:this.handleAuthorizationRequest(e,t);break;case IncomingPayloadType.CANCEL:this.handleCancel(e,t);break;default:vLog.Error("Unknown request type "+r)}},Router.prototype.handleAuthorizationRequest=function(e,r){var t=this._servers[r.serverID];if(!t){var n=JSON.stringify({err:new vError.ExistsError("unknown server")});return void this._proxy.sendRequest(n,MessageType.AUTHORIZATION_RESPONSE,null,e)}var o=this,i=new SecurityContext(r.context,this._proxy);t.handleAuthorization(r.handle,i).then(function(){o._proxy.sendRequest("{}",MessageType.AUTHORIZATION_RESPONSE,null,e)}).catch(function(t){var n=JSON.stringify({err:ErrorConversion.toStandardErrorStruct(t,this._appName,r.context.method)});o._proxy.sendRequest(n,MessageType.AUTHORIZATION_RESPONSE,null,e)})},Router.prototype.handleLookupRequest=function(e,r){var t=this._servers[r.serverID];if(!t){var n=JSON.stringify({err:new vError.ExistsError("unknown server")});return void this._proxy.sendRequest(n,MessageType.LOOKUP_RESPONSE,null,e)}var o=this;t._handleLookup(r.suffix,r.method).then(function(t){var n="function"==typeof t.authorizer,i=t.service.labelForMethod(r.method),s={signature:IdlHelper.generateIdlWireDescription(t.service),hasAuthorizer:n,handle:t._handle,label:i};o._proxy.sendRequest(JSON.stringify(s),MessageType.LOOKUP_RESPONSE,null,e)}).catch(function(t){var n=JSON.stringify({err:ErrorConversion.toStandardErrorStruct(t,o._appName,r.method)});o._proxy.sendRequest(n,MessageType.LOOKUP_RESPONSE,null,e)})},Router.prototype.handleCancel=function(e){var r=this._contextMap[e];r&&r.cancel()},Router.prototype.handleRPCRequest=function(e,r){var t,n=this._servers[r.serverId];if(!n)return t=new Error("Request for unknown server "+r.serverId),void this.sendResult(e,r.method,null,t);var o=n.getServiceForHandle(r.handle);if(!o)return t=new Error("No service found"),void this.sendResult(e,r.method,null,t);var i=o.object,s=i[r.method];if(void 0===s)return t=new Error("Requested method "+r.method+" not found on"),void this.sendResult(e,r.method,null,t);var a=o.metadata[r.method],u=this,d=function(t,n){var o;t instanceof Error&&void 0!==t.stack&&(o=t.stack),vLog.debug("Requested method "+r.method+" threw an exception on invoke: ",t,o);var i,s=n.numOutArgs;switch(s){case 0:break;case 1:i=null;break;default:i=new Array(s)}u.sendResult(e,r.method,i,t,n)},l=r.args,p=new ServerContext(r,this._proxy);this._contextMap[e]=p;var c=!1,h=function(t,n){c||(c=!0,p.remoteId.release(),u.sendResult(e,r.method,n,t,a))},v={$stream:new Stream(e,this._proxy.senderPromise,!1),$cb:h,$context:p,$suffix:p.suffix,$name:p.name,$remoteId:p.remoteId},y=inject(l,a.injections,v);if(-1!==y.indexOf("$stream")){var f=v.$stream;this._streamMap[e]=f;var m=new StreamHandler(f);this._proxy.addIncomingStreamHandler(e,m)}var g=this.invokeMethod(i,s,l);if(g instanceof Error)return void d(g,a);var _=Promise.resolve(g);-1===y.indexOf("$cb")&&_.then(function(t){c||(p.remoteId.release(),c=!0,u.sendResult(e,r.method,t,null,a))},function(e){if(!c){if(c=!0,!(e instanceof Error)){var r;r="undefined"==typeof e||null===e?"Unknown exception.":JSON.stringify(e),e=new Error(r)}d(e,a)}})},Router.prototype.sendResult=function(e,r,t,n,o){var i=[];if(o)switch(o.numOutArgs){case 0:void 0!==t&&vLog.error("Unexpected return value from "+r+": "+t),i=[];break;case 1:i=[t];break;default:Array.isArray(t)?(t.length!==o.numOutArgs&&vLog.error("Wrong number of arguments returned by "+r+". expected: "+o.numOutArgs+", got:"+t.length),i=t):(vLog.error("Wrong number of arguments returned by "+r+". expected: "+o.numOutArgs+", got: 1"),i=[t])}else i=[t];var s=null;void 0!==n&&null!==n&&(s=ErrorConversion.toStandardErrorStruct(n,this._appName,r));var a=this._contextMap[e];a&&(a.waitUntilDone().catch(function(){}),a.cancel(),delete this._contextMap[e]);var u=this._streamMap[e];if(u)u.serverClose(t,s),this._proxy.dequeue(e);else{var d={results:i,err:s},l=JSON.stringify(d);this._proxy.sendRequest(l,MessageType.RESPONSE,null,e)}},Router.prototype.serve=function(e,r,t){vLog.info("Serving under the name: ",e);var n={name:e,serverId:r.id};this._servers[r.id]=r;var o=new Deferred(t),i=JSON.stringify(n),s=this._proxy.id;this._proxy.id+=2;var a=new SimpleHandler(o,this._proxy,s);return this._proxy.sendRequest(i,MessageType.SERVE,a,s),o.promise},Router.prototype.stopServer=function(e,r){var t=this,n=new Deferred(r),o=this._proxy.id;this._proxy.id+=2;var i=new SimpleHandler(n,this._proxy,o);return this._proxy.sendRequest(e.id.toString(),MessageType.STOP,i,o),n.promise.then(function(r){return delete t._servers[e.id],r})},module.exports=Router;
},{"../lib/promise":71,"../lib/verror":72,"../proxy/error_conversion":76,"../proxy/incoming_payload_type":77,"../proxy/message_type":78,"../proxy/simple_handler":80,"../proxy/stream":81,"../proxy/stream_handler":82,"../security/context":89,"./../idl/idl":63,"./../lib/deferred":70,"./../lib/vlog":73,"./server_context":68}],70:[function(require,module,exports){
...
var MessageType={REQUEST:0,SERVE:1,RESPONSE:2,STREAM_VALUE:3,STREAM_CLOSE:4,SIGNATURE:5,STOP:6,BLESS:8,UNLINK_ID:9,NEW_ID:10,LOOKUP_RESPONSE:11,AUTHORIZATION_RESPONSE:12,NAMESPACE_REQUEST:13,CANCEL:17};module.exports=MessageType;
...
function Runtime(e){return this instanceof Runtime?(this.identityName=e.identityName,this._wspr=e.wspr,this.identity=new PrivateId(this._getProxyConnection()),void(this._name=e.appName)):new Runtime(e)}var Server=require("../ipc/server"),ServerRouter=require("../ipc/server_router"),Client=require("../ipc/client"),ProxyConnection=require("../proxy/websocket"),MessageType=require("../proxy/message_type"),Namespace=require("../namespace/namespace"),PrivateId=require("../security/private"),PublicId=require("../security/public"),Deferred=require("../lib/deferred"),SimpleHandler=require("../proxy/simple_handler");module.exports=Runtime,Runtime.prototype.bindTo=function(e,t,r){var n=this,i=this._getClient();return"function"==typeof t&&(r=t,t=void 0),r&&(r=r.bind(n)),i.bindTo(e,t,r)},Runtime.prototype.close=function(e){var t=this;return t._getProxyConnection().close(e)},Runtime.prototype.serve=function(e,t,r,n){var i=this._getServer();return i.serve(e,t,r,n)},Runtime.prototype.addIDL=function(e){var t=this._getServer();return t.addIDL(e)},Runtime.prototype._getProxyConnection=function(){return this._proxyConnection||(this._proxyConnection=new ProxyConnection(this._wspr)),this._proxyConnection},Runtime.prototype._getRouter=function(){return this._router||(this._router=new ServerRouter(this._getProxyConnection(),this._name)),this._router},Runtime.prototype._getClient=function(){return this._client=this._client||new Client(this._getProxyConnection()),this._client},Runtime.prototype._getServer=function(){return this._server=this._server||new Server(this._getRouter()),this._server},Runtime.prototype.newNamespace=function(e){var t=this._getProxyConnection();return new Namespace(t,e)},Runtime.prototype.newIdentity=function(e,t){var r=new Deferred(t),n=new Deferred,i=this._getProxyConnection(),o=i.nextId(),s=new SimpleHandler(n,i,o);return i.sendRequest(JSON.stringify(e),MessageType.NEW_ID,s,o),n.promise.then(function(e){var t=new PublicId(e.names,e.handle,e.publicKey,i);r.resolve(t)},r.reject),r.promise};
},{"../ipc/client":64,"../ipc/server":67,"../ipc/server_router":69,"../lib/deferred":70,"../namespace/namespace":74,"../proxy/message_type":78,"../proxy/simple_handler":80,"../proxy/websocket":83,"../security/private":90,"../security/public":91}],86:[function(require,module,exports){
function authorizer(r){return function(e){if(e.localId&&e.remoteId&&e.localId.publicKey===e.remoteId.publicKey)return null;for(var n=e.remoteId.names,t=0;t<n.length;t++)if(matchesACL(n[t],e.label,r))return null;return errACL}}function matchesACL(r,e,n){var t,i,o=!1;for(t in n.in)if(n.in.hasOwnProperty(t)&&(i=n.in[t],blessingMatches(r,t)&&-1!==i.indexOf(e))){o=!0;break}if(!o)return!1;for(t in n.notIn)if(n.notIn.hasOwnProperty(t)&&(t.lastIndexOf("...")===t.length-4&&(t=t.substr(0,t.length-3)),i=n.notIn[t],blessingMatches(t,r)&&-1!==i.indexOf(e)))return!1;return!0}var blessingMatches=require("./blessing_matching"),vError=require("./../lib/verror");module.exports=authorizer;var errACL=new vError.NoAccessError("acl authorization failed");
...
function Context(e,t){this.method=e.method,this.name=e.name,this.suffix=e.suffix,this.label=e.label,this.localId=new PublicId(e.localID.names,e.localID.handle,e.localID.publicKey,t),this.remoteId=new PublicId(e.remoteID.names,e.remoteID.handle,e.remoteID.publicKey,t),this.localEndpoint=e.localEndpoint,this.remoteEndpoint=e.remoteEndpoint}var PublicId=require("./public.js");module.exports=Context;
},{"./public.js":91}],90:[function(require,module,exports){
function PrivateId(e){this._proxy=e}var Deferred=require("../lib/deferred"),SimpleHandler=require("../proxy/simple_handler"),PublicId=require("./public"),MessageType=require("../proxy/message_type");PrivateId.prototype.bless=function(e,r,i,n,s){var t=new Deferred(s);if(!(e instanceof PublicId))return t.reject(new Error("blessee should be of type PublicId")),t.promise;var a=JSON.stringify({handle:e._id,name:r,durationMs:i,caveats:n}),d=this._proxy.nextId(),o=new SimpleHandler(t,this._proxy,d);this._proxy.sendRequest(a,MessageType.BLESS,o,d);var p=this._proxy;return t.promise.then(function(e){var r=new PublicId(e.names,e.handle,e.publicKey,p._proxy);return r})},module.exports=PrivateId;
},{"../lib/deferred":70,"../proxy/message_type":78,"../proxy/simple_handler":80,"./public":91}],91:[function(require,module,exports){
function PublicId(t,e,i,s){this.names=t,this._id=e,this._count=1,this._proxy=s,this._key=i}var MessageType=require("../proxy/message_type"),blessingMatches=require("./blessing_matching");PublicId.prototype.match=function(t){if(""===t||!t)return!1;for(var e=0;e<this.names.length;e++)if(blessingMatches(this.names[e],t))return!0;return!1},PublicId.prototype.retain=function(){this._count++},PublicId.prototype.release=function(){if(this._count--,0===this._count){var t=JSON.stringify(this._id);this._proxy.sendRequest(t,MessageType.UNLINK_ID,null,this._proxy.nextId())}},PublicId.prototype.toJSON=function(){return{id:this._id,names:this.names,key:this._key}},module.exports=PublicId;
},{"../proxy/message_type":78,"./blessing_matching":87}],92:[function(require,module,exports){
(function (process){
function init(e,r){"function"==typeof e&&(r=e,e={}),e=extend(defaults,e);var t=new Deferred(r),n={wspr:e.wspr||process.env.WSPR||"http://localhost:8124",appName:e.appName||"webapp"};return e.authenticate?getIdentity(e.authTimeout,function(e,r){return e?(t.reject(e),t.promise):(n.identityName=r,void t.resolve(new Runtime(n)))}):(n.identityName="unknown",t.resolve(new Runtime(n))),t.promise}function getIdentity(e,r){function t(e){u(),r(null,e.name)}function n(e){u(),r(objectToError(e.error))}function i(){window.clearInterval(s)}function o(){n({error:new Error("Auth timeout. Please ensure that the Veyron Chrome Extension is installed and enabled. Download it here: https://github.com/veyron/veyron.js/raw/master/extension/veyron.crx")})}function u(){window.clearInterval(s),window.clearTimeout(a),l.removeListener("auth:success",t),l.removeListener("auth:error",n)}if(!isBrowser)return r(new Error("authenticate=true requires browser environment"));var a,s,c=require("postie"),l=new c(window);l.on("auth:success",t),l.on("auth:error",n),l.on("auth:received",i),s=window.setInterval(function(){l.post("auth")},200),a=window.setTimeout(o,e)}function objectToError(e){var r=new Error(e.message);return r.name=e.name,r.stack=e.stack,r}var extend=require("xtend"),isBrowser=require("is-browser"),Deferred=require("./lib/deferred"),Runtime=require("./runtime/runtime"),vlog=require("./lib/vlog"),defaults={logLevel:vlog.level,authenticate:!1,authTimeout:5e3};module.exports={errors:require("./lib/verror"),init:init,logLevels:require("./lib/vlog").levels,namespaceUtil:require("./namespace/util"),Promise:require("./lib/promise"),createLeafDispatcher:require("./ipc/leaf_dispatcher"),caveats:require("./security/caveat"),aclAuthorizer:require("./security/acl_authorizer")};
}).call(this,require("FWaASH"))
},{"./ipc/leaf_dispatcher":66,"./lib/deferred":70,"./lib/promise":71,"./lib/verror":72,"./lib/vlog":73,"./namespace/util":75,"./runtime/runtime":85,"./security/acl_authorizer":86,"./security/caveat":88,"FWaASH":42,"is-browser":59,"postie":60,"xtend":62}]},{},[92])
