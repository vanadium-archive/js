...
(function (process){
function init(e,r){"function"==typeof e&&(r=e,e={}),e=extend(defaults,e);var t=new Deferred(r),i={wspr:e.wspr||process.env.WSPR||"http://localhost:8124",appName:e.appName||"webapp"};return e.authenticate?getIdentity(e.authTimeout,function(e,r){return e?(t.reject(e),t.promise):(i.identityName=r,void t.resolve(new Runtime(i)))}):(i.identityName="unknown",t.resolve(new Runtime(i))),t.promise}function getIdentity(e,r){function t(e){u(),r(null,e.name)}function i(e){u(),r(objectToError(e.error))}function n(){window.clearInterval(s)}function o(){i(new Error("Auth timeout. Please ensure that the Veyron Chrome Extension is installed and enabled. Download it here: https://github.com/veyron/veyron.js/raw/master/extension/veyron.crx"))}function u(){window.clearInterval(s),window.clearTimeout(a),l.removeListener("auth:success",t),l.removeListener("auth:error",i)}if(!isBrowser)return r(new Error("authenticate=true requires browser environment"));var a,s,c=require("postie"),l=new c(window);l.on("auth:success",t),l.on("auth:error",i),l.on("auth:received",n),s=window.setInterval(function(){l.post("auth")},200),a=window.setTimeout(o,e)}function objectToError(e){var r=new Error(e.message);return r.name=e.name,r.stack=e.stack,r}var extend=require("xtend"),isBrowser=require("is-browser"),Deferred=require("./lib/deferred"),Runtime=require("./runtime/runtime"),vlog=require("./lib/vlog"),defaults={logLevel:vlog.level,authenticate:!1,authTimeout:5e3};module.exports={errors:require("./lib/verror"),init:init,logLevels:require("./lib/vlog").levels,namespaceUtil:require("./namespace/util"),Promise:require("./lib/promise"),createLeafDispatcher:require("./ipc/leaf_dispatcher"),vom:{Kind:require("./vom/kind"),Types:require("./vom/types")},caveats:require("./security/caveat"),aclAuthorizer:require("./security/acl_authorizer")};
}).call(this,require("FWaASH"))
},{"./ipc/leaf_dispatcher":65,"./lib/deferred":68,"./lib/promise":69,"./lib/verror":70,"./lib/vlog":71,"./namespace/util":74,"./runtime/runtime":83,"./security/acl_authorizer":84,"./security/caveat":86,"./vom/kind":91,"./vom/types":92,"FWaASH":42,"is-browser":59,"postie":60,"xtend":62}],91:[function(require,module,exports){
var kindCount=0,kind={ANY:kindCount++,ONEOF:kindCount++,NILABLE:kindCount++,BOOL:kindCount++,BYTE:kindCount++,UINT16:kindCount++,UINT32:kindCount++,UINT64:kindCount++,INT16:kindCount++,INT32:kindCount++,INT64:kindCount++,FLOAT32:kindCount++,FLOAT64:kindCount++,COMPLEX64:kindCount++,COMPLEX128:kindCount++,STRING:kindCount++,ENUM:kindCount++,TYPEVAL:kindCount++,ARRAY:kindCount++,LIST:kindCount++,SET:kindCount++,MAP:kindCount++,STRUCT:kindCount++};module.exports=kind;
},{}],92:[function(require,module,exports){
function primitiveType(i){return{kind:i}}var Kind=require("./kind.js");module.exports={ANY:primitiveType(Kind.ANY),BOOL:primitiveType(Kind.BOOL),BYTE:primitiveType(Kind.BYTE),UINT16:primitiveType(Kind.UINT16),UINT32:primitiveType(Kind.UINT32),UINT64:primitiveType(Kind.UINT64),INT16:primitiveType(Kind.INT16),INT32:primitiveType(Kind.INT32),INT64:primitiveType(Kind.INT64),FLOAT32:primitiveType(Kind.FLOAT32),FLOAT64:primitiveType(Kind.FLOAT64),COMPLEX64:primitiveType(Kind.COMPLEX64),COMPLEX128:primitiveType(Kind.COMPLEX128),STRING:primitiveType(Kind.STRING),TYPEVAL:primitiveType(Kind.TYPEVAL)};
},{"./kind.js":91}]},{},[90])
