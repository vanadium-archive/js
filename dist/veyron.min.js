...
},{"./lib/_stream_duplex.js":44,"./lib/_stream_passthrough.js":45,"./lib/_stream_readable.js":46,"./lib/_stream_transform.js":47,"./lib/_stream_writable.js":48,"stream":56}],54:[function(require,module,exports){
...
function Context(s,e){this.method=s.method,this.name=s.name,this.suffix=s.suffix,this.label=s.label,this.localBlessings=new Blessings(s.localBlessings.handle,s.localBlessings.publicKey,e),this.remoteBlessings=new Blessings(s.remoteBlessings.handle,s.remoteBlessings.publicKey,e),this.localBlessingStrings=s.localBlessingStrings,this.remoteBlessingStrings=s.remoteBlessingStrings,this.localEndpoint=s.localEndpoint,this.remoteEndpoint=s.remoteEndpoint}var Blessings=require("./blessings.js");module.exports=Context;
},{"./blessings.js":88}],91:[function(require,module,exports){
function Principal(e){this._proxy=e}var Deferred=require("../lib/deferred"),SimpleHandler=require("../proxy/simple_handler"),Blessings=require("./blessings"),MessageType=require("../proxy/message_type");Principal.prototype.bless=function(e,r,s,i,n){var p=new Deferred(n);if(!(e instanceof Blessings))return p.reject(new Error("blessee should be of type Blessings")),p.promise;var t=JSON.stringify({handle:e._id,name:r,durationMs:s,caveats:i}),l=this._proxy.nextId(),o=new SimpleHandler(p,this._proxy,l);this._proxy.sendRequest(t,MessageType.BLESS_PUBLICKEY,o,l);var a=this._proxy;return p.promise.then(function(e){var r=new Blessings(e.handle,e.publicKey,a._proxy);return r})},module.exports=Principal;
},{"../lib/deferred":70,"../proxy/message_type":78,"../proxy/simple_handler":80,"./blessings":88}],92:[function(require,module,exports){
(function (process){
function init(e,r){"function"==typeof e&&(r=e,e={}),e=extend(defaults,e);var t=new Deferred(r),n={wspr:e.wspr||process.env.WSPR||"http://localhost:8124",appName:e.appName||"webapp"};return e.authenticate?getAccount(e.authTimeout,function(e,r){return e?(t.reject(e),t.promise):(n.accountName=r,void t.resolve(new Runtime(n)))}):(n.accountName="unknown",t.resolve(new Runtime(n))),t.promise}function getAccount(e,r){function t(e){u(),r(null,e.name)}function n(e){u(),r(objectToError(e.error))}function o(){window.clearInterval(s)}function i(){n({error:new Error("Auth timeout. Please ensure that the Veyron Chrome Extension is installed and enabled. Download it here: https://github.com/veyron/veyron.js/raw/master/extension/veyron.crx")})}function u(){window.clearInterval(s),window.clearTimeout(a),l.removeListener("auth:success",t),l.removeListener("auth:error",n)}if(!isBrowser)return r(new Error("authenticate=true requires browser environment"));var a,s,c=require("postie"),l=new c(window);l.on("auth:success",t),l.on("auth:error",n),l.on("auth:received",o),s=window.setInterval(function(){l.post("auth")},200),a=window.setTimeout(i,e)}function objectToError(e){var r=new Error(e.message);return r.name=e.name,r.stack=e.stack,r}var extend=require("xtend"),isBrowser=require("is-browser"),Deferred=require("./lib/deferred"),Runtime=require("./runtime/runtime"),vlog=require("./lib/vlog"),defaults={logLevel:vlog.level,authenticate:!1,authTimeout:5e3};module.exports={errors:require("./lib/verror"),init:init,logLevels:require("./lib/vlog").levels,namespaceUtil:require("./namespace/util"),Promise:require("./lib/promise"),createLeafDispatcher:require("./ipc/leaf_dispatcher"),caveats:require("./security/caveat"),aclAuthorizer:require("./security/acl_authorizer")};
}).call(this,require("FWaASH"))
