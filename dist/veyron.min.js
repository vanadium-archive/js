...
(function (process){
function init(e,r){"function"==typeof e&&(r=e,e={}),vlog.level=e.logLevel||vlog.level;var n=new Deferred(r);return getIdentity(function(r,t){r&&n.reject(r);var i={wspr:e.wspr||process.env.WSPR||"http://localhost:8124",identityName:t};n.resolve(new Runtime(i))}),n.promise}function getIdentity(e){function r(r){i(),e(null,r.name)}function n(r){i(),e(r)}function t(){window.clearInterval(s)}function i(){window.clearInterval(s),u.removeListener("auth:success",r),u.removeListener("auth:Error",n)}var o="object"==typeof window;if(!o)return process.nextTick(e.bind(null,null));var l=require("postie"),u=new l(window);u.on("auth:success",r),u.on("auth:error",n),u.on("auth:received",t);var s=window.setInterval(function(){u.post("auth")},200)}var Runtime=require("./runtime/runtime"),Deferred=require("./lib/deferred"),vlog=require("./lib/vlog");module.exports={init:init,logLevels:require("./lib/vlog").levels,namespaceUtil:require("./namespace/util"),errors:require("./lib/verror")};
}).call(this,require("FWaASH"))
