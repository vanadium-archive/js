...
},{"FWaASH":42}],29:[function(_dereq_,module,exports){
...
},{"./_stream_readable":46,"./_stream_writable":48,"FWaASH":42,"core-util-is":49,"inherits":41}],45:[function(_dereq_,module,exports){
...
},{"FWaASH":42,"buffer":36,"core-util-is":49,"events":40,"inherits":41,"isarray":50,"stream":56,"string_decoder/":51}],47:[function(_dereq_,module,exports){
...
},{"./_stream_duplex":44,"FWaASH":42,"buffer":36,"core-util-is":49,"inherits":41,"stream":56}],49:[function(_dereq_,module,exports){
(function (Buffer){
...
},{"buffer":36}],50:[function(_dereq_,module,exports){
...
},{"buffer":36}],52:[function(_dereq_,module,exports){
module.exports=_dereq_("./lib/_stream_passthrough.js");
},{"./lib/_stream_passthrough.js":45}],53:[function(_dereq_,module,exports){
var Stream=_dereq_("stream");exports=module.exports=_dereq_("./lib/_stream_readable.js"),exports.Stream=Stream,exports.Readable=exports,exports.Writable=_dereq_("./lib/_stream_writable.js"),exports.Duplex=_dereq_("./lib/_stream_duplex.js"),exports.Transform=_dereq_("./lib/_stream_transform.js"),exports.PassThrough=_dereq_("./lib/_stream_passthrough.js");
},{"./lib/_stream_duplex.js":44,"./lib/_stream_passthrough.js":45,"./lib/_stream_readable.js":46,"./lib/_stream_transform.js":47,"./lib/_stream_writable.js":48,"stream":56}],54:[function(_dereq_,module,exports){
...
var vError=_dereq_("../lib/verror"),idlHelper={};idlHelper.generateIdlWireDescription=function(r){var e={},t=r.metadata;for(var a in t)if(t.hasOwnProperty(a)){for(var n=t[a],o=n.params,i=[],s=0;s<o.length;s++){var u=o[s];"$"!==u[0]&&i.push(u)}e[a]={InArgs:i,NumOutArgs:n.numOutArgs+1,IsStreaming:void 0!==n.injections.$stream}}return e};var getParamNames=function(r){var e=r.toString().replace(/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm,""),t=e.slice(e.indexOf("(")+1,e.indexOf(")")).match(/([^\s,]+)/g);return null===t&&(t=[]),t};idlHelper.ServiceWrapper=function(r,e){this.object=r,this.metadata={},e=e||{};for(var t in r)if(t.length>0&&"_"!==t[0]){if(t[0]>="A"&&t[0]<="Z"){var a=t.charAt(0).toLowerCase()+t.slice(1);throw new Error("Method names must be camel case. Perhaps rename '"+t+"' to '"+a+"'")}var n=r[t];if("function"==typeof n){for(var o=getParamNames(n),i={},s=0;s<o.length;s++){var u=o[s];"$"===u[0]&&(i[u]=s)}var m={params:o,injections:i,numOutArgs:1};if(e[t]){var g=e[t];void 0!==g.numOutArgs&&(m.numOutArgs=g.numOutArgs),m.label=g.label}this.metadata[t]=m}}},idlHelper.ServiceWrapper.prototype.validate=function(r){for(var e in r)if(r.hasOwnProperty(e)){var t=this.metadata[e];if(!t)return new vError.BadArgError("Missing method: "+e);var a=r[e],n=t.params.length-Object.keys(t.injections).length;if(n!==a.numInArgs)return new vError.BadArgError("Wrong number of input args for "+e+", got: "+n+", expected: "+a.numInArgs);if(t.numOutArgs!==a.numOutArgs)return new vError.BadArgError("Wrong number of output args for "+e+", got: "+t.numOutArgs+", expected "+a.numOutArgs);var o=t.injections.hasOwnProperty("$stream"),i=a.inputStreaming||a.outputStreaming;if(i&&!o)return new vError.BadArgError("Expected "+e+" to be streaming");if(!i&&o)return new vError.BadArgError("Expected "+e+" to not be streaming")}for(e in this.metadata)if(this.metadata.hasOwnProperty(e)&&!r.hasOwnProperty(e))return new vError.BadArgError("Unexpected method "+e+" implemented.");return null},idlHelper.ServiceWrapper.prototype.labelForMethod=function(r){return this.metadata.hasOwnProperty(r)?this.metadata[r].label||0:0},module.exports=idlHelper;
},{"../lib/verror":72}],64:[function(_dereq_,module,exports){
function Client(e){return this instanceof Client?void(this._proxyConnection=e):new Client(e)}var Promise=_dereq_("../lib/promise"),Deferred=_dereq_("../lib/deferred"),vLog=_dereq_("../lib/vlog"),ErrorConversion=_dereq_("../proxy/error_conversion"),Stream=_dereq_("../proxy/stream"),vError=_dereq_("../lib/verror"),MessageType=_dereq_("../proxy/message_type"),IncomingPayloadType=_dereq_("../proxy/incoming_payload_type"),context=_dereq_("../runtime/context"),constants=_dereq_("./constants"),OutstandingRPC=function(e,t,r){this._ctx=e,this._proxy=t.proxy,this._id=-1,this._name=t.name,this._methodName=t.methodName,this._args=t.args,this._numOutParams=t.numOutParams,this._isStreaming=t.isStreaming||!1,this._cb=r,this._def=null};OutstandingRPC.prototype.start=function(){this._id=this._proxy.nextId();var e=new Deferred(this._cb),t=null;this._isStreaming&&(t=new Deferred,e.stream=new Stream(this._id,t.promise,!0),e.promise.stream=e.stream);var r=this.constructMessage();return this._def=e,this._proxy.cancelFromContext(this._ctx,this._id),this._proxy.sendRequest(r,MessageType.REQUEST,this,this._id),t&&this._proxy.senderPromise.then(function(e){t.resolve(e)},function(e){t.reject(e)}),e.promise},OutstandingRPC.prototype.handleResponse=function(e,t){switch(e){case IncomingPayloadType.FINAL_RESPONSE:this.handleCompletion(t);break;case IncomingPayloadType.STREAM_RESPONSE:this.handleStreamData(t);break;case IncomingPayloadType.ERROR_RESPONSE:this.handleError(t);break;case IncomingPayloadType.STREAM_CLOSE:this.handleStreamClose();break;default:this.handleError(new vError.InternalError("Recieved unknown response type from wspr"))}},OutstandingRPC.prototype.handleCompletion=function(e){1===e.length&&(e=e[0]),this._def.resolve(e),this._def.stream&&this._def.stream._queueRead(null),this._proxy.dequeue(this._id)},OutstandingRPC.prototype.handleStreamData=function(e){this._def.stream?this._def.stream._queueRead(e):vLog.warn("Ignoring streaming message for non-streaming flow : "+this._id)},OutstandingRPC.prototype.handleStreamClose=function(){this._def.stream&&this._def.stream._queueRead(null)},OutstandingRPC.prototype.handleError=function(e){var t;t=e instanceof Error?e:ErrorConversion.toJSerror(e),this._def.stream&&(this._def.stream.emit("error",t),this._def.stream.queueRead(null)),this._def.reject(t),this._proxy.dequeue(this._id)},OutstandingRPC.prototype.constructMessage=function(){var e=this._ctx.deadline(),t=constants.NO_TIMEOUT;null!==e&&(t=e-Date.now());var r={name:this._name,method:this._methodName,inArgs:this._args||[],numOutArgs:this._numOutParams||1,isStreaming:this._isStreaming,timeout:t};return JSON.stringify(r)},Client.prototype.bindTo=function(e,t,r,n){n=context.optionalContext(arguments);var i=this;"function"!=typeof n&&(r=n,n=void 0),"function"==typeof r&&(n=r,r=void 0);var s,o=new Deferred(n);if(void 0!==r)s=Promise.resolve(r);else{vLog.debug("Requesting service signature for:",t);var a=i._proxyConnection;s=a.getServiceSignature(e,t)}var u=o.promise;return s.then(function(e){vLog.debug("Received signature for:",t,e);var r={},n=function(n){var s=e[n],o=s.numOutArgs;r[n]=function(){var e,r,a=0,u=arguments.length-1;u>=0&&(arguments[a]instanceof context.Context&&(a++,r=arguments[0]),"function"==typeof arguments[u]&&(e=arguments[u],u--));var m=Array.prototype.slice.call(arguments,a,u+1);r||(r=new context.Context);var d=s.inArgs.length,h=m.length;if(h!==d){var c=["Invalid number of arguments to",'"'+n+'".',"Expected",d,"but there were",h+"."].join(" "),g=new Deferred(e),p=new Error(c);return g.reject(p),g.promise}var l=new OutstandingRPC(r,{proxy:i._proxyConnection,name:t,methodName:n,args:m,numOutParams:o,isStreaming:s.isStreaming},e);return l.start()}};for(var s in e)e.hasOwnProperty(s)&&n(s);r.signature=function(t){var r=new Deferred(t);return r.resolve(e),r.promise},o.resolve(r)}).catch(o.reject),u},module.exports=Client;
},{"../lib/deferred":70,"../lib/promise":71,"../lib/verror":72,"../lib/vlog":73,"../proxy/error_conversion":76,"../proxy/incoming_payload_type":77,"../proxy/message_type":78,"../proxy/stream":81,"../runtime/context":84,"./constants":65}],65:[function(_dereq_,module,exports){
module.exports={NO_TIMEOUT:9223372036854};
},{}],66:[function(_dereq_,module,exports){
function createLeafDispatcher(e,r,a){var i=new ServiceWrapper(e,r);if(r&&r._validate){var t=i.validate(i.metadata);if(t)throw t}return function(){return{service:i,authorizer:a}}}var IdlHelper=_dereq_("./../idl/idl"),ServiceWrapper=IdlHelper.ServiceWrapper;module.exports=createLeafDispatcher;
},{"./../idl/idl":63}],67:[function(_dereq_,module,exports){
function Server(e){return this instanceof Server?(this._router=e,this._handle=0,this.id=nextServerID++,this.dispatcher=null,void(this.serviceObjectHandles={})):new Server(e)}var Deferred=_dereq_("./../lib/deferred"),Promise=_dereq_("./../lib/promise"),IdlHelper=_dereq_("./../idl/idl"),ServiceWrapper=IdlHelper.ServiceWrapper,vLog=_dereq_("./../lib/vlog"),nextServerID=1;Server.prototype.serve=function(e,r,t){return this.dispatcher=r,this._router.serve(e,this,t)},Server.prototype.stop=function(e){return this._router.stopServer(this,e)},Server.prototype.getServiceForHandle=function(e){var r=this.serviceObjectHandles[e];return delete this.serviceObjectHandles[e],r.service},Server.prototype.handleAuthorization=function(e,r){function t(e){return e?void n.reject(e):void n.resolve()}var i=this.serviceObjectHandles[e];if(!i||!i.authorizer)return Promise.reject(new Error("Unknown handle "+e));var o,n=new Deferred;try{o=i.authorizer(r,t)}catch(s){return vLog.error(s),Promise.reject(s)}return void 0===o?n.promise:null===o?Promise.resolve():o.then?o:Promise.reject(o)},Server.prototype._handleLookupResult=function(e){return e.service instanceof ServiceWrapper?(e._handle=this._handle,this.serviceObjectHandles[e._handle]=e,this._handle++,null):new Error("The result of lookup should be of type ServiceWrapper")},Server.prototype._handleLookup=function(e,r){function t(e,r){if(e)return void s.reject(e);var t=n._handleLookupResult(r);t?s.reject(t):s.resolve(r)}function i(e){var r=n._handleLookupResult(e);return r?Promise.reject(r):Promise.resolve(e)}var o,n=this,s=new Deferred;try{o=this.dispatcher(e,r,t)}catch(v){return s.reject(v),vLog.error(v),s.promise}if(void 0===o)return s.promise.then(i);if(o instanceof Error)return s.reject(o),s.promise;var u=Promise.resolve(o);return u.then(i)},module.exports=Server;
},{"./../idl/idl":63,"./../lib/deferred":70,"./../lib/promise":71,"./../lib/vlog":73}],68:[function(_dereq_,module,exports){
function ServerContext(t,e){return this instanceof ServerContext?(this._ctx=new context.Context,this._ctx=t.context.timeout!==constants.NO_TIMEOUT?this._ctx.withTimeout(t.context.timeout):this._ctx.withCancel(),this.suffix=t.context.suffix,this.name=t.context.name,this.remoteBlessings=new Blessings(t.context.remoteBlessings.handle,t.context.remoteBlessings.publicKey,e),void(this.remoteBlessingStrings=t.context.remoteBlessingStrings)):new ServerContext}var Blessings=_dereq_("../security/blessings"),context=_dereq_("../runtime/context"),inherits=_dereq_("util").inherits,constants=_dereq_("./constants");module.exports=ServerContext,inherits(ServerContext,context.Context),ServerContext.prototype.deadline=function(){return this._ctx.deadline()},ServerContext.prototype.done=function(){return this._ctx.done()},ServerContext.prototype.waitUntilDone=function(t){return this._ctx.waitUntilDone(t)},ServerContext.prototype.value=function(){return this._ctx.value()},ServerContext.prototype.cancel=function(){return this._ctx.cancel()};
},{"../runtime/context":84,"../security/blessings":88,"./constants":65,"util":58}],69:[function(_dereq_,module,exports){
var Promise=_dereq_("../lib/promise"),Stream=_dereq_("../proxy/stream"),MessageType=_dereq_("../proxy/message_type"),IncomingPayloadType=_dereq_("../proxy/incoming_payload_type"),ErrorConversion=_dereq_("../proxy/error_conversion"),Deferred=_dereq_("./../lib/deferred"),vLog=_dereq_("./../lib/vlog"),SimpleHandler=_dereq_("../proxy/simple_handler"),StreamHandler=_dereq_("../proxy/stream_handler"),vError=_dereq_("../lib/verror"),IdlHelper=_dereq_("./../idl/idl"),SecurityContext=_dereq_("../security/context"),ServerContext=_dereq_("./server_context"),Router=function(e,r){this._servers={},this._proxy=e,this._streamMap={},this._contextMap={},this._appName=r,e.addIncomingHandler(IncomingPayloadType.INVOKE_REQUEST,this),e.addIncomingHandler(IncomingPayloadType.LOOKUP_REQUEST,this),e.addIncomingHandler(IncomingPayloadType.AUTHORIZATION_REQUEST,this),e.addIncomingHandler(IncomingPayloadType.CANCEL,this)},inject=function(e,r,t){var n=Object.keys(r),o={};n.forEach(function(e){o[r[e]]=e});var s=n.map(function(e){return r[e]});s.filter(function(e){return void 0!==e}),s.sort();var i=[];return s.forEach(function(r){var n=o[r];e.splice(r,0,t[n]),i.push(n)}),i};Router.prototype.invokeMethod=function(e,r,t){try{return r.apply(e,t)}catch(n){if(!(n instanceof Error)){var o;return o="undefined"==typeof n||null===n?"Unknown exception.":JSON.stringify(n),new Error(o)}return n}},Router.prototype.handleRequest=function(e,r,t){switch(r){case IncomingPayloadType.INVOKE_REQUEST:this.handleRPCRequest(e,t);break;case IncomingPayloadType.LOOKUP_REQUEST:this.handleLookupRequest(e,t);break;case IncomingPayloadType.AUTHORIZATION_REQUEST:this.handleAuthorizationRequest(e,t);break;case IncomingPayloadType.CANCEL:this.handleCancel(e,t);break;default:vLog.Error("Unknown request type "+r)}},Router.prototype.handleAuthorizationRequest=function(e,r){var t=this._servers[r.serverID];if(!t){var n=JSON.stringify({err:new vError.ExistsError("unknown server")});return void this._proxy.sendRequest(n,MessageType.AUTHORIZATION_RESPONSE,null,e)}var o=this,s=new SecurityContext(r.context,this._proxy);t.handleAuthorization(r.handle,s).then(function(){o._proxy.sendRequest("{}",MessageType.AUTHORIZATION_RESPONSE,null,e)}).catch(function(t){var n=JSON.stringify({err:ErrorConversion.toStandardErrorStruct(t,this._appName,r.context.method)});o._proxy.sendRequest(n,MessageType.AUTHORIZATION_RESPONSE,null,e)})},Router.prototype.handleLookupRequest=function(e,r){var t=this._servers[r.serverID];if(!t){var n=JSON.stringify({err:new vError.ExistsError("unknown server")});return void this._proxy.sendRequest(n,MessageType.LOOKUP_RESPONSE,null,e)}var o=this;t._handleLookup(r.suffix,r.method).then(function(t){var n="function"==typeof t.authorizer,s=t.service.labelForMethod(r.method),i={signature:IdlHelper.generateIdlWireDescription(t.service),hasAuthorizer:n,handle:t._handle,label:s};o._proxy.sendRequest(JSON.stringify(i),MessageType.LOOKUP_RESPONSE,null,e)}).catch(function(t){var n=JSON.stringify({err:ErrorConversion.toStandardErrorStruct(t,o._appName,r.method)});o._proxy.sendRequest(n,MessageType.LOOKUP_RESPONSE,null,e)})},Router.prototype.handleCancel=function(e){var r=this._contextMap[e];r&&r.cancel()},Router.prototype.handleRPCRequest=function(e,r){var t,n=this._servers[r.serverId];if(!n)return t=new Error("Request for unknown server "+r.serverId),void this.sendResult(e,r.method,null,t);var o=n.getServiceForHandle(r.handle);if(!o)return t=new Error("No service found"),void this.sendResult(e,r.method,null,t);var s=o.object,i=s[r.method];if(void 0===i)return t=new Error("Requested method "+r.method+" not found on"),void this.sendResult(e,r.method,null,t);var a=o.metadata[r.method],u=this,d=function(t,n){var o;t instanceof Error&&void 0!==t.stack&&(o=t.stack),vLog.debug("Requested method "+r.method+" threw an exception on invoke: ",t,o);var s,i=n.numOutArgs;switch(i){case 0:break;case 1:s=null;break;default:s=new Array(i)}u.sendResult(e,r.method,s,t,n)},l=r.args,p=new ServerContext(r,this._proxy);this._contextMap[e]=p;var c=!1,h=function(t,n){c||(c=!0,p.remoteBlessings.release(),u.sendResult(e,r.method,n,t,a))},v={$stream:new Stream(e,this._proxy.senderPromise,!1),$cb:h,$context:p,$suffix:p.suffix,$name:p.name,$remoteBlessings:p.remoteBlessings},y=inject(l,a.injections,v);if(-1!==y.indexOf("$stream")){var f=v.$stream;this._streamMap[e]=f;var m=new StreamHandler(f);this._proxy.addIncomingStreamHandler(e,m)}var g=this.invokeMethod(s,i,l);if(g instanceof Error)return void d(g,a);var _=Promise.resolve(g);-1===y.indexOf("$cb")&&_.then(function(t){c||(p.remoteBlessings.release(),c=!0,u.sendResult(e,r.method,t,null,a))},function(e){if(!c){if(c=!0,!(e instanceof Error)){var r;r="undefined"==typeof e||null===e?"Unknown exception.":JSON.stringify(e),e=new Error(r)}d(e,a)}})},Router.prototype.sendResult=function(e,r,t,n,o){var s=[];if(o)switch(o.numOutArgs){case 0:void 0!==t&&vLog.error("Unexpected return value from "+r+": "+t),s=[];break;case 1:s=[t];break;default:Array.isArray(t)?(t.length!==o.numOutArgs&&vLog.error("Wrong number of arguments returned by "+r+". expected: "+o.numOutArgs+", got:"+t.length),s=t):(vLog.error("Wrong number of arguments returned by "+r+". expected: "+o.numOutArgs+", got: 1"),s=[t])}else s=[t];var i=null;void 0!==n&&null!==n&&(i=ErrorConversion.toStandardErrorStruct(n,this._appName,r));var a=this._contextMap[e];a&&(a.waitUntilDone().catch(function(){}),a.cancel(),delete this._contextMap[e]);var u=this._streamMap[e];if(u)u.serverClose(t,i),this._proxy.dequeue(e);else{var d={results:s,err:i},l=JSON.stringify(d);this._proxy.sendRequest(l,MessageType.RESPONSE,null,e)}},Router.prototype.serve=function(e,r,t){vLog.info("Serving under the name: ",e);var n={name:e,serverId:r.id};this._servers[r.id]=r;var o=new Deferred(t),s=JSON.stringify(n),i=this._proxy.id;this._proxy.id+=2;var a=new SimpleHandler(o,this._proxy,i);return this._proxy.sendRequest(s,MessageType.SERVE,a,i),o.promise},Router.prototype.stopServer=function(e,r){var t=this,n=new Deferred(r),o=this._proxy.id;this._proxy.id+=2;var s=new SimpleHandler(n,this._proxy,o);return this._proxy.sendRequest(e.id.toString(),MessageType.STOP,s,o),n.promise.then(function(r){return delete t._servers[e.id],r})},module.exports=Router;
},{"../lib/promise":71,"../lib/verror":72,"../proxy/error_conversion":76,"../proxy/incoming_payload_type":77,"../proxy/message_type":78,"../proxy/simple_handler":80,"../proxy/stream":81,"../proxy/stream_handler":82,"../security/context":90,"./../idl/idl":63,"./../lib/deferred":70,"./../lib/vlog":73,"./server_context":68}],70:[function(_dereq_,module,exports){
function Deferred(e){var r=this;r.promise=new Promise(function(e,o){r.resolve=e,r.reject=o}),addCallback(r.promise,e)}function addCallback(e,r){r&&e.done(function(e){r(null,e)},function(e){r(e)})}var Promise=_dereq_("./promise");module.exports=Deferred,Deferred.prototype.addCallback=function(e){addCallback(this.promise,e)};
},{"./promise":71}],71:[function(_dereq_,module,exports){
module.exports=_dereq_("bluebird");
},{"bluebird":3}],72:[function(_dereq_,module,exports){
var inherits=_dereq_("util").inherits,vError={};vError.Actions={NoRetry:0,RetryConnection:1,RetryRefetch:2,RetryBackoff:3},vError.IdActions={Aborted:{id:"veyron.io/veyron/veyron2/verror.Aborted",action:vError.Actions.NoRetry},BadArg:{id:"veyron.io/veyron/veyron2/verror.BadArg",action:vError.Actions.NoRetry},BadProtocol:{id:"veyron.io/veyron/veyron2/verror.BadProtocol",action:vError.Actions.NoRetry},Exists:{id:"veyron.io/veyron/veyron2/verror.Exists",action:vError.Actions.NoRetry},Internal:{id:"veyron.io/veyron/veyron2/verror.Internal",action:vError.Actions.NoRetry},NoAccess:{id:"veyron.io/veyron/veyron2/verror.NoAccess",action:vError.Actions.NoRetry},NoExist:{id:"veyron.io/veyron/veyron2/verror.NoExist",action:vError.Actions.NoRetry},NoExistOrNoAccess:{id:"veyron.io/veyron/veyron2/verror.NoExistOrNoAccess",action:vError.Actions.NoRetry},Unknown:{id:"veyron.io/veyron/veyron2/verror.Unknown",action:vError.Actions.NoRetry}},vError.VeyronError=function(r,o){return this instanceof vError.VeyronError?(Error.call(this),this.message=r||"",this.idAction=o||vError.IdActions.Unknown,this.idAction.id||(this.idAction.id=vError.IdActions.Unknown.id),void("function"==typeof Error.captureStackTrace?Error.captureStackTrace(this,vError.VeyronError):this.stack=(new Error).stack)):new vError.VeyronError(r,o)},inherits(vError.VeyronError,Error),vError.AbortedError=function(r){return this instanceof vError.AbortedError?void vError.VeyronError.call(this,r,vError.IdActions.Aborted):new vError.AbortedError(r)},inherits(vError.AbortedError,vError.VeyronError),vError.BadArgError=function(r){return this instanceof vError.BadArgError?void vError.VeyronError.call(this,r,vError.IdActions.BadArg):new vError.BadArgError(r)},inherits(vError.BadArgError,vError.VeyronError),vError.BadProtocolError=function(r){return this instanceof vError.BadProtocolError?void vError.VeyronError.call(this,r,vError.IdActions.BadProtocol):new vError.BadProtocolError(r)},inherits(vError.BadProtocolError,vError.VeyronError),vError.ExistsError=function(r){return this instanceof vError.ExistsError?void vError.VeyronError.call(this,r,vError.IdActions.Exists):new vError.ExistsError(r)},inherits(vError.ExistsError,vError.VeyronError),vError.InternalError=function(r){return this instanceof vError.InternalError?void vError.VeyronError.call(this,r,vError.IdActions.Internal):new vError.InternalError(r)},inherits(vError.InternalError,vError.VeyronError),vError.NoAccessError=function(r){return this instanceof vError.NoAccessError?void vError.VeyronError.call(this,r,vError.IdActions.NoAccess):new vError.NoAccessError(r)},inherits(vError.NoAccessError,vError.VeyronError),vError.NoExistError=function(r){return this instanceof vError.NoExistError?void vError.VeyronError.call(this,r,vError.IdActions.NoExist):new vError.NoExistError(r)},inherits(vError.NoExistError,vError.VeyronError),vError.NoExistOrNoAccessError=function(r){return this instanceof vError.NoExistOrNoAccessError?void vError.VeyronError.call(this,r,vError.IdActions.NoExistOrNoAccess):new vError.NoExistOrNoAccessError(r)},inherits(vError.NoExistOrNoAccessError,vError.VeyronError),vError.UnknownError=function(r){return this instanceof vError.UnknownError?void vError.VeyronError.call(this,r):new vError.UnknownError(r)},inherits(vError.UnknownError,vError.VeyronError),module.exports=vError;
},{"util":58}],73:[function(_dereq_,module,exports){
var extend=_dereq_("xtend"),levels={NOLOG:0,ERROR:1,WARN:2,DEBUG:3,INFO:4},defaults={level:levels.NOLOG,console:console},Vlog=function(e){if(!(this instanceof Vlog))return new Vlog(e);var o=this;e=extend(defaults,e),o.level=e.level,o.console=e.console};Vlog.prototype.error=function(){this._log(levels.ERROR,arguments)},Vlog.prototype.warn=function(){this._log(levels.WARN,arguments)},Vlog.prototype.debug=function(){this._log(levels.DEBUG,arguments)},Vlog.prototype.info=function(){this._log(levels.INFO,arguments)},Vlog.prototype._log=function(e,o){this.level>=e&&this._write(e,o)},Vlog.prototype._write=function(e,o){var l,s=this;if(s.console){switch(e){case levels.ERROR:l=s.console.error;break;case levels.WARN:l=s.console.warn;break;case levels.DEBUG:l=s.console.log;break;case levels.INFO:l=s.console.info;break;default:l=s.console.log}l.apply(s.console,o)}},module.exports=new Vlog,module.exports.Vlog=Vlog,module.exports.levels=levels;
},{"xtend":62}],74:[function(_dereq_,module,exports){
function Namespace(e,r){this._proxy=e,this._roots=r}var Deferred=_dereq_("../lib/deferred"),MessageType=_dereq_("../proxy/message_type"),Stream=_dereq_("../proxy/stream"),StreamHandler=_dereq_("../proxy/stream_handler"),SimpleHandler=_dereq_("../proxy/simple_handler");module.exports=Namespace;var NamespaceMethods={GLOB:0,MOUNT:1,UNMOUNT:2,RESOLVE:3,RESOLVETOMT:4,FLUSHCACHEENTRY:5,DISABLECACHE:6,ROOTS:7};Namespace.prototype.glob=function(e,r){var t={pattern:e};return this._sendStreamingRequest(NamespaceMethods.GLOB,t,r)},Namespace.prototype.mount=function(e,r,t,s,a){t=t||0,s=!!s;var o={name:e,server:r,ttl:1e3*t,replaceMount:s};return this._sendRequest(NamespaceMethods.MOUNT,o,a)},Namespace.prototype.unmount=function(e,r,t){r=r||"";var s={name:e,server:r};return this._sendRequest(NamespaceMethods.UNMOUNT,s,t)},Namespace.prototype.resolve=function(e,r){var t={name:e};return this._sendRequest(NamespaceMethods.RESOLVE,t,r)},Namespace.prototype.resolveToMounttable=function(e,r){var t={name:e};return this._sendRequest(NamespaceMethods.RESOLVETOMT,t,r)},Namespace.prototype.flushCacheEntry=function(e,r){var t={name:e};return this._sendRequest(NamespaceMethods.FLUSHCACHEENTRY,t,r)},Namespace.prototype.disableCache=function(e,r){e=!!e;var t={disable:e};return this._sendRequest(NamespaceMethods.DISABLECACHE,t,r)},Namespace.prototype.roots=function(e){return this._sendRequest(NamespaceMethods.ROOTS,null,e)},Namespace.prototype.setRoots=function(e,r){Array.isArray(e)||(e=Array.prototype.slice.call(arguments),r="function"==typeof e[e.length-1]?e.pop():null);var t=new Deferred(r);return this._roots=e,t.resolve(),t.promise},Namespace.prototype._sendRequest=function(e,r,t){var s=new Deferred(t),a=this._proxy.nextId(),o=new SimpleHandler(s,this._proxy,a),n=this._createMessage(e,r);return this._proxy.sendRequest(n,MessageType.NAMESPACE_REQUEST,o,a),s.promise},Namespace.prototype._sendStreamingRequest=function(e,r,t){var s=new Deferred(t),a=this._proxy.nextId();s.stream=new Stream(a,this._proxy.senderPromise,!0);var o=new StreamHandler(s.stream),n=this._createMessage(e,r);return this._proxy.sendRequest(n,MessageType.NAMESPACE_REQUEST,null,a),this._proxy.addIncomingStreamHandler(a,o),s.promise.stream=s.stream,s.promise},Namespace.prototype._createMessage=function(e,r){var t={method:e,args:r||null,roots:this._roots||[]};return JSON.stringify(t)};
},{"../lib/deferred":70,"../proxy/message_type":78,"../proxy/simple_handler":80,"../proxy/stream":81,"../proxy/stream_handler":82}],75:[function(_dereq_,module,exports){
var _numInitialSlashes=function(n){for(var e=0;e<n.length;e++)if("/"!==n.charAt(e))return e;return n.length},_numTailSlashes=function(n){for(var e=n.length-1;e>=0;e--)if("/"!==n.charAt(e))return n.length-1-e;return n.length},_removeInitialSlashes=function(n){return n.replace(/^\/*/g,"")},_removeTailSlashes=function(n){return n.replace(/\/*$/g,"")},_joinNamePartsOnArray=function(n){if(0===n.length)return"";for(var e=n[0],r=1;r<n.length;r++){var a=n[r],t=_numTailSlashes(e),s=_numInitialSlashes(a);0!==t||0!==s?s>t?(e=_removeTailSlashes(e),e+=a):e+=_removeInitialSlashes(a):e+="/"+a}return e},join=function(n){return _joinNamePartsOnArray(Array.isArray(n)?n:Array.prototype.slice.call(arguments))},isRooted=function(n){return 1===_numInitialSlashes(n)},stripBasename=function(n){return n.substring(0,n.lastIndexOf("/")+1)},basename=function(n){return n.substring(n.lastIndexOf("/")+1)};module.exports={join:join,isRooted:isRooted,stripBasename:stripBasename,basename:basename};
},{}],76:[function(_dereq_,module,exports){
function toStandardErrorStruct(r,o,t){var n=vError.IdActions.Unknown,i="",a=[];return r instanceof Error?(i=r.message,r.idAction&&(n=r.idAction),a=r.paramList||[]):void 0!==r&&null!==r&&(i=r+""),!a[0]&&o&&(a[0]=o),!a[1]&&t&&(a[1]=t),new _standard(n,i,a)}function toJSerror(r){var o,t=r.iDAction||r.idAction,n=t.iD||t.id,i=r.msg||n+": "+r.paramList.join(" "),a=errors[n];return o=a?new a(i):new vError.VeyronError(i,t),o.paramList=r.paramList||[],o}var vError=_dereq_("./../lib/verror");module.exports={toStandardErrorStruct:toStandardErrorStruct,toJSerror:toJSerror};var _standard=function(r,o,t){this.idAction=r,this.msg=o,this.paramList=t},errors={};Object.keys(vError.IdActions).forEach(function(r){var o=vError.IdActions[r],t=vError[r+"Error"];errors[o.id]=t});
},{"./../lib/verror":72}],77:[function(_dereq_,module,exports){
var IncomingPayloadType={FINAL_RESPONSE:0,STREAM_RESPONSE:1,ERROR_RESPONSE:2,INVOKE_REQUEST:3,STREAM_CLOSE:4,LOOKUP_REQUEST:5,AUTHORIZATION_REQUEST:6,CANCEL:7};module.exports=IncomingPayloadType;
},{}],78:[function(_dereq_,module,exports){
var MessageType={REQUEST:0,SERVE:1,RESPONSE:2,STREAM_VALUE:3,STREAM_CLOSE:4,SIGNATURE:5,STOP:6,BLESS_PUBLICKEY:7,UNLINK_BLESSINGS:8,NEW_BLESSINGS:9,LOOKUP_RESPONSE:11,AUTHORIZATION_RESPONSE:12,NAMESPACE_REQUEST:13,CANCEL:17};module.exports=MessageType;
},{}],79:[function(_dereq_,module,exports){
function Proxy(e){this.id=1,this.outstandingRequests={},this.bindCache={},this.senderPromise=e,this.incomingRequestHandlers={}}var MessageType=_dereq_("./message_type"),IncomingPayloadType=_dereq_("./incoming_payload_type"),Deferred=_dereq_("./../lib/deferred"),vLog=_dereq_("./../lib/vlog"),SimpleHandler=_dereq_("./simple_handler"),context=_dereq_("../runtime/context"),BIND_CACHE_TTL=36e5;Proxy.prototype.process=function(e){var t,n=e.id%2===0,i=this.outstandingRequests[e.id];try{t=JSON.parse(e.data)}catch(o){return void(n||i.handleResponse(IncomingPayloadType.ERROR_RESPONSE,e.data))}if(!n&&!i)return void vLog.warn("Dropping message for unknown flow "+e.id+" "+e.data);if(i)i.handleResponse(t.type,t.message);else{if(i=this.incomingRequestHandlers[t.type],!i)return void vLog.warn("Dropping message for unknown invoke payload "+t.type);i.handleRequest(e.id,t.type,t.message)}},Proxy.prototype.dequeue=function(e){delete this.outstandingRequests[e]},Proxy.prototype.nextId=function(){var e=this.id;return this.id+=2,e},Proxy.prototype.getServiceSignature=function(e,t){t=context.optionalContext(arguments);var n=this,i=new Deferred,o=Date.now,s=this.bindCache[t];if(s&&o()-s.fetched<BIND_CACHE_TTL)return i.resolve(s.signature),i.promise;i.promise.then(function(e){n.bindCache[t]={signature:e,fetched:o()}});var r={name:t},a=JSON.stringify(r),d=n.nextId(),u=new SimpleHandler(i,n,d);return this.cancelFromContext(e,d),n.sendRequest(a,MessageType.SIGNATURE,u,d),i.promise},Proxy.prototype.addIncomingHandler=function(e,t){this.incomingRequestHandlers[e]=t},Proxy.prototype.addIncomingStreamHandler=function(e,t){this.outstandingRequests[e]=t},Proxy.prototype.cancelFromContext=function(e,t){var n=this;e.waitUntilDone().catch(function(e){var i=n.outstandingRequests[t];n.sendRequest(null,MessageType.CANCEL,null,t),i&&(i.handleResponse(IncomingPayloadType.ERROR_RESPONSE,e),delete n.outstandingRequests[t])})},Proxy.prototype.sendRequest=function(e,t,n,i){n&&(this.outstandingRequests[i]=n);var o=JSON.stringify({id:i,data:e,type:t}),s=this;this.senderPromise.then(function(e){e.send(o)}).catch(function(e){var t=s.outstandingRequests[i];t&&(t.handleResponse(IncomingPayloadType.ERROR_RESPONSE,e),delete s.outstandingRequests[i])})},module.exports=Proxy;
},{"../runtime/context":84,"./../lib/deferred":70,"./../lib/vlog":73,"./incoming_payload_type":77,"./message_type":78,"./simple_handler":80}],80:[function(_dereq_,module,exports){
var IncomingPayloadType=_dereq_("./incoming_payload_type"),ErrorConversion=_dereq_("./error_conversion"),vError=_dereq_("./../lib/verror"),Handler=function(r,e,o){this._proxy=e,this._def=r,this._id=o};Handler.prototype.handleResponse=function(r,e){switch(r){case IncomingPayloadType.FINAL_RESPONSE:this._def.resolve(e);break;case IncomingPayloadType.ERROR_RESPONSE:var o=e;o instanceof Error||(o=ErrorConversion.toJSerror(e)),this._def.reject(o);break;default:this._def.reject(new vError.InternalError("unknown response type "+r))}this._proxy.dequeue(this._id)},module.exports=Handler;
},{"./../lib/verror":72,"./error_conversion":76,"./incoming_payload_type":77}],81:[function(_dereq_,module,exports){
var MessageType=_dereq_("./message_type"),Duplex=_dereq_("stream").Duplex,inherits=_dereq_("util").inherits,Stream=function(e,t,s){Duplex.call(this,{objectMode:!0}),this.flowId=e,this.isClient=s,this.webSocketPromise=t,this.onmessage=null,this.wsBuffer=[],this.shouldQueue=!1};inherits(Stream,Duplex),Stream.prototype.clientClose=function(){var e={id:this.flowId,type:MessageType.STREAM_CLOSE};Duplex.prototype.write.call(this,e)},Stream.prototype.serverClose=function(e,t){var s={id:this.flowId,type:MessageType.RESPONSE,data:JSON.stringify({results:[e||null],err:t||null})};Duplex.prototype.write.call(this,s)},Stream.prototype._read=function(){for(var e=0;e<this.wsBuffer.length&&this.push(this.wsBuffer[e]);)++e;e>0&&(this.wsBuffer=this.wsBuffer.splice(e)),this.shouldQueue=0===this.wsBuffer.length},Stream.prototype._queueRead=function(e){this.shouldQueue?this.shouldQueue=this.push(e):this.wsBuffer.push(e)},Stream.prototype.write=function(e,t,s){var i={id:this.flowId,data:JSON.stringify(e),type:MessageType.STREAM_VALUE};return Duplex.prototype.write.call(this,i,t,s)},Stream.prototype._write=function(e,t,s){this.webSocketPromise.then(function(t){t.send(JSON.stringify(e)),s()})},Stream.prototype.end=function(e,t,s){this.isClient?(void 0!==e&&this.write(e,t),this.clientClose()):this.serverClose(),Duplex.prototype.end.call(this,null,null,s)},module.exports=Stream;
},{"./message_type":78,"stream":56,"util":58}],82:[function(_dereq_,module,exports){
function Handler(e){this._stream=e}var IncomingPayloadType=_dereq_("./incoming_payload_type"),ErrorConversion=_dereq_("./error_conversion");module.exports=Handler,Handler.prototype.handleResponse=function(e,r){switch(e){case IncomingPayloadType.STREAM_RESPONSE:this._stream._queueRead(r);break;case IncomingPayloadType.STREAM_CLOSE:this._stream._queueRead(null);break;case IncomingPayloadType.ERROR_RESPONSE:this._stream.emit("error",ErrorConversion.toJSerror(r))}};
},{"./error_conversion":76,"./incoming_payload_type":77}],83:[function(_dereq_,module,exports){
function ProxyConnection(e){this.url=e.replace(/^(http|https)/,"ws")+"/ws",this.currentWebSocketPromise=null;var r=new Deferred;Proxy.call(this,r.promise),r.resolve(this.getWebSocket())}var WebSocket=_dereq_("ws"),Deferred=_dereq_("./../lib/deferred"),vLog=_dereq_("./../lib/vlog"),Proxy=_dereq_("./proxy"),isBrowser=_dereq_("is-browser");ProxyConnection.prototype=Object.create(Proxy.prototype),ProxyConnection.prototype.constructor=ProxyConnection,ProxyConnection.prototype.getWebSocket=function(){if(this.currentWebSocketPromise)return this.currentWebSocketPromise;var e=new WebSocket(this.url),r=this,o=new Deferred;return this.currentWebSocketPromise=o.promise,e.onopen=function(){vLog.info("Connected to proxy at",r.url),o.resolve(e)},e.onerror=function(e){vLog.error("Failed to connect to proxy at url:",r.url);var t=isBrowser&&!!window.Event&&e instanceof window.Event,n=t&&"error"===e.type;n&&(e=new Error("WebSocket error - "+r.url)),o.reject(e)},e.onmessage=function(e){var o;try{o=JSON.parse(e.data)}catch(t){return void vLog.warn("Failed to parse "+e.data)}r.process(o)},o.promise},ProxyConnection.prototype.close=function(e){function r(e){e.onclose=t.resolve,e.close()}var o=this,t=new Deferred(e);return o.getWebSocket().then(r,function(){t.resolve()}),t.promise},module.exports=ProxyConnection;
},{"./../lib/deferred":70,"./../lib/vlog":73,"./proxy":79,"is-browser":59,"ws":61}],84:[function(_dereq_,module,exports){
function optionalContext(e){var t=e.length-1;if(t>=0&&e[0]instanceof Context)return e[t];for(var n=e[t],o=t;o>0;o--)e[o]=e[o-1];return e[0]=new Context({}),n}function DeadlineExceededError(){return this instanceof DeadlineExceededError?void vError.AbortedError.call(this,"deadline exceeded"):new DeadlineExceededError}function CancelledError(){return this instanceof CancelledError?void vError.AbortedError.call(this,"cancelled"):new CancelledError}function ContextKey(){return this instanceof ContextKey?(this._key=ContextKey._nextKey,void ContextKey._nextKey++):new ContextKey}function Context(){return this instanceof Context?void 0:new Context}function ChildContext(e){this._parent=e,Context.call(this)}function ValueContext(e,t,n){if(!(t instanceof ContextKey))throw new vError.BadArgError("Attempting to set a value on a context, but the key is not of type ContextKey.");this._key=t,this._value=n,ChildContext.call(this,e)}function cancellableAncestor(e){for(;e instanceof ChildContext;e=e._parent)if(e instanceof CancelContext)return e;return null}function CancelContext(e){this._id=CancelContext._nextID,CancelContext._nextID++,this._done=!1,this._deferred=new Deferred,this._children={};var t=cancellableAncestor(e);t&&(t._children[this._id]=this),ChildContext.call(this,e)}function DeadlineContext(e,t){this._deadline=t,this._timerID=setTimeout(this._expire.bind(this),t-Date.now()),CancelContext.call(this,e)}var Deferred=_dereq_("../lib/deferred"),Promise=_dereq_("../lib/promise"),vError=_dereq_("../lib/verror"),inherits=_dereq_("util").inherits;module.exports={optionalContext:optionalContext,Context:Context,ContextKey:ContextKey,DeadlineExceededError:DeadlineExceededError,CancelledError:CancelledError},inherits(DeadlineExceededError,vError.AbortedError),inherits(CancelledError,vError.AbortedError),ContextKey._nextKey=0,Context.prototype.deadline=function(){return null},Context.prototype.done=function(){return!1},Context.prototype.waitUntilDone=function(){return new Promise(function(){})},Context.prototype.value=function(){return null},Context.prototype.withValue=function(e,t){return new ValueContext(this,e,t)},Context.prototype.withCancel=function(){return new CancelContext(this)},Context.prototype.withDeadline=function(e){return new DeadlineContext(this,e)},Context.prototype.withTimeout=function(e){return new DeadlineContext(this,Date.now()+e)},inherits(ChildContext,Context),ChildContext.prototype.deadline=function(){return this._parent.deadline()},ChildContext.prototype.done=function(){return this._parent.done()},ChildContext.prototype.waitUntilDone=function(e){return this._parent.waitUntilDone(e)},ChildContext.prototype.value=function(){return this._parent.value()},inherits(ValueContext,ChildContext),ValueContext.prototype.value=function(e){if(!(e instanceof ContextKey))throw new vError.BadArgError("Attempting to look up a value on a context, but the key is not of type ContextKey.");return e._key===this._key._key?this._value:this._parent.value(e)},inherits(CancelContext,ChildContext),CancelContext._nextID=0,CancelContext.prototype.done=function(){return this._done},CancelContext.prototype._cancel=function(e){this._done=!0,this._deferred.reject(e);for(var t in this._children)this._children.hasOwnProperty(t)&&this._children[t]._cancel(e);this._children={}},CancelContext.prototype.cancel=function(){var e=cancellableAncestor(this._parent);e&&delete e._children[this._id],this._cancel(new CancelledError)},CancelContext.prototype.waitUntilDone=function(e){return this._deferred.addCallback(e),this._deferred.promise},inherits(DeadlineContext,CancelContext),DeadlineContext.prototype.deadline=function(){return this._deadline},DeadlineContext.prototype._cancel=function(e){clearTimeout(this._timerID),CancelContext.prototype._cancel.call(this,e)},DeadlineContext.prototype._expire=function(){this._cancel(new DeadlineExceededError)};
},{"../lib/deferred":70,"../lib/promise":71,"../lib/verror":72,"util":58}],85:[function(_dereq_,module,exports){
function Runtime(e){return this instanceof Runtime?(this.accountName=e.accountName,this._wspr=e.wspr,this.principal=new Principal(this._getProxyConnection()),void(this._name=e.appName)):new Runtime(e)}var Server=_dereq_("../ipc/server"),ServerRouter=_dereq_("../ipc/server_router"),Client=_dereq_("../ipc/client"),ProxyConnection=_dereq_("../proxy/websocket"),MessageType=_dereq_("../proxy/message_type"),Namespace=_dereq_("../namespace/namespace"),Principal=_dereq_("../security/principal"),Blessings=_dereq_("../security/blessings"),Deferred=_dereq_("../lib/deferred"),SimpleHandler=_dereq_("../proxy/simple_handler");module.exports=Runtime,Runtime.prototype.bindTo=function(e,t,r){var n=this,i=this._getClient();return"function"==typeof t&&(r=t,t=void 0),r&&(r=r.bind(n)),i.bindTo(e,t,r)},Runtime.prototype.close=function(e){var t=this;return t._getProxyConnection().close(e)},Runtime.prototype.serve=function(e,t,r,n){var i=this._getServer();return i.serve(e,t,r,n)},Runtime.prototype.addIDL=function(e){var t=this._getServer();return t.addIDL(e)},Runtime.prototype._getProxyConnection=function(){return this._proxyConnection||(this._proxyConnection=new ProxyConnection(this._wspr)),this._proxyConnection},Runtime.prototype._getRouter=function(){return this._router||(this._router=new ServerRouter(this._getProxyConnection(),this._name)),this._router},Runtime.prototype._getClient=function(){return this._client=this._client||new Client(this._getProxyConnection()),this._client},Runtime.prototype._getServer=function(){return this._server=this._server||new Server(this._getRouter()),this._server},Runtime.prototype.newNamespace=function(e){var t=this._getProxyConnection();return new Namespace(t,e)},Runtime.prototype.newBlessings=function(e,t){var r=new Deferred(t),n=new Deferred,i=this._getProxyConnection(),o=i.nextId(),s=new SimpleHandler(n,i,o);return i.sendRequest(JSON.stringify(e),MessageType.NEW_BLESSINGS,s,o),n.promise.then(function(e){var t=new Blessings(e.handle,e.publicKey,i);r.resolve(t)},r.reject),r.promise};
},{"../ipc/client":64,"../ipc/server":67,"../ipc/server_router":69,"../lib/deferred":70,"../namespace/namespace":74,"../proxy/message_type":78,"../proxy/simple_handler":80,"../proxy/websocket":83,"../security/blessings":88,"../security/principal":91}],86:[function(_dereq_,module,exports){
function authorizer(r){return function(e){if(e.localBlessings&&e.remoteBlessings&&e.localBlessings.publicKey===e.remoteBlessings.publicKey)return null;var n=e.remoteBlessingStrings;if((void 0===n||0===n.length)&&canAccessACL("",e.label,r))return null;for(var s=0;s<n.length;s++)if(canAccessACL(n[s],e.label,r))return null;return errACL}}function canAccessACL(r,e,n){var s,i,t=!1;for(s in n.in)if(n.in.hasOwnProperty(s)&&(i=n.in[s],blessingMatches(r,s)&&-1!==i.indexOf(e))){t=!0;break}if(!t)return!1;for(s in n.notIn)if(n.notIn.hasOwnProperty(s)&&(s.lastIndexOf("...")===s.length-4&&(s=s.substr(0,s.length-3)),i=n.notIn[s],blessingMatches(s,r)&&-1!==i.indexOf(e)))return!1;return!0}var blessingMatches=_dereq_("./blessing_matching"),vError=_dereq_("./../lib/verror");module.exports=authorizer;var errACL=new vError.NoAccessError("acl authorization failed");
},{"./../lib/verror":72,"./blessing_matching":87}],87:[function(_dereq_,module,exports){
function blessingMatches(e,t){for(var n=e.split("/"),r=t.split("/"),l=0;l<r.length;l++){if("..."===r[l])return l===r.length-1;if(l===n.length)return!0;if(n[l]!==r[l])return!1}return n.length===r.length}module.exports=blessingMatches;
},{}],88:[function(_dereq_,module,exports){
function Blessings(s,t,e){this._id=s,this._count=1,this._proxy=e,this._key=t}var MessageType=_dereq_("../proxy/message_type");Blessings.prototype.retain=function(){this._count++},Blessings.prototype.release=function(){if(this._count--,0===this._count){var s=JSON.stringify(this._id);this._proxy.sendRequest(s,MessageType.UNLINK_BLESSINGS,null,this._proxy.nextId())}},Blessings.prototype.toJSON=function(){return{id:this._id,key:this._key}},module.exports=Blessings;
},{"../proxy/message_type":78}],89:[function(_dereq_,module,exports){
function MethodCaveat(t){this._methods=t}module.exports={MethodCaveat:MethodCaveat},MethodCaveat.prototype.toJSON=function(){return{_type:"MethodCaveat",data:this._methods}};
},{}],90:[function(_dereq_,module,exports){
function Context(s,e){this.method=s.method,this.name=s.name,this.suffix=s.suffix,this.label=s.label,this.localBlessings=new Blessings(s.localBlessings.handle,s.localBlessings.publicKey,e),this.remoteBlessings=new Blessings(s.remoteBlessings.handle,s.remoteBlessings.publicKey,e),this.localBlessingStrings=s.localBlessingStrings,this.remoteBlessingStrings=s.remoteBlessingStrings,this.localEndpoint=s.localEndpoint,this.remoteEndpoint=s.remoteEndpoint}var Blessings=_dereq_("./blessings.js");module.exports=Context;
},{"./blessings.js":88}],91:[function(_dereq_,module,exports){
function Principal(e){this._proxy=e}var Deferred=_dereq_("../lib/deferred"),SimpleHandler=_dereq_("../proxy/simple_handler"),Blessings=_dereq_("./blessings"),MessageType=_dereq_("../proxy/message_type");Principal.prototype.bless=function(e,r,s,i,n){var t=new Deferred(n);if(!(e instanceof Blessings))return t.reject(new Error("blessee should be of type Blessings")),t.promise;var p=JSON.stringify({handle:e._id,extension:r,durationMs:s,caveats:i}),o=this._proxy.nextId(),l=new SimpleHandler(t,this._proxy,o);this._proxy.sendRequest(p,MessageType.BLESS_PUBLICKEY,l,o);var a=this._proxy;return t.promise.then(function(e){var r=new Blessings(e.handle,e.publicKey,a._proxy);return r})},module.exports=Principal;
},{"../lib/deferred":70,"../proxy/message_type":78,"../proxy/simple_handler":80,"./blessings":88}],92:[function(_dereq_,module,exports){
(function (process){
function init(e,r){"function"==typeof e&&(r=e,e={}),e=extend(defaults,e);var t=new Deferred(r),n={wspr:e.wspr||process.env.WSPR||"http://localhost:8124",appName:e.appName||"webapp"};return e.authenticate?getAccount(e.authTimeout,function(e,r){return e?(t.reject(e),t.promise):(n.accountName=r,void t.resolve(new Runtime(n)))}):(n.accountName="unknown",t.resolve(new Runtime(n))),t.promise}function getAccount(e,r){function t(e){u(),r(null,e.account)}function n(e){u(),r(objectToError(e.error))}function o(){window.clearInterval(s)}function i(){n({error:new Error("Auth timeout. Please ensure that the Veyron Chrome Extension is installed and enabled. Download it here: https://github.com/veyron/veyron.js/raw/master/extension/veyron.crx")})}function u(){window.clearInterval(s),window.clearTimeout(a),l.removeListener("auth:success",t),l.removeListener("auth:error",n)}if(!isBrowser)return r(new Error("authenticate=true requires browser environment"));var a,s,c=_dereq_("postie"),l=new c(window);l.on("auth:success",t),l.on("auth:error",n),l.on("auth:received",o),s=window.setInterval(function(){l.post("auth")},200),a=window.setTimeout(i,e)}function objectToError(e){var r=new Error(e.message);return r.name=e.name,r.stack=e.stack,r}var extend=_dereq_("xtend"),isBrowser=_dereq_("is-browser"),Deferred=_dereq_("./lib/deferred"),Runtime=_dereq_("./runtime/runtime"),vlog=_dereq_("./lib/vlog"),defaults={logLevel:vlog.level,authenticate:!1,authTimeout:5e3};module.exports={errors:_dereq_("./lib/verror"),init:init,logLevels:_dereq_("./lib/vlog").levels,namespaceUtil:_dereq_("./namespace/util"),Promise:_dereq_("./lib/promise"),createLeafDispatcher:_dereq_("./ipc/leaf_dispatcher"),caveats:_dereq_("./security/caveat"),aclAuthorizer:_dereq_("./security/acl_authorizer")};
}).call(this,_dereq_("FWaASH"))
},{"./ipc/leaf_dispatcher":66,"./lib/deferred":70,"./lib/promise":71,"./lib/verror":72,"./lib/vlog":73,"./namespace/util":75,"./runtime/runtime":85,"./security/acl_authorizer":86,"./security/caveat":89,"FWaASH":42,"is-browser":59,"postie":60,"xtend":62}]},{},[92])
