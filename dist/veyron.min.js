...
function toStandardErrorStruct(r){var o="",t="";return r instanceof Error?(t=r.message,"Error"!==r.name&&(o=r.name)):void 0!==r&&null!==r&&(t=r+""),new _standard(o,t)}function toJSerror(r){var o,t=errIdConstrMap[r.iD];return o=t?new t(r.msg):new vError.VeyronError(r.msg,r.iD)}var vError=require("./../lib/verror");module.exports={toStandardErrorStruct:toStandardErrorStruct,toJSerror:toJSerror};var _standard=function(r,o){this.iD=r,this.msg=o},errIdConstrMap={};errIdConstrMap[vError.Ids.Aborted]=vError.AbortedError,errIdConstrMap[vError.Ids.BadArg]=vError.BadArgError,errIdConstrMap[vError.Ids.BadProtocol]=vError.BadProtocolError,errIdConstrMap[vError.Ids.Exists]=vError.ExistsError,errIdConstrMap[vError.Ids.Internal]=vError.InternalError,errIdConstrMap[vError.Ids.NoAccess]=vError.NoAccessError,errIdConstrMap[vError.Ids.NoExist]=vError.NoExistError,errIdConstrMap[vError.Ids.NoExistOrNoAccess]=vError.NoExistOrNoAccessError;
