...
(function (process){
function init(e,r){"function"==typeof e&&(r=e,e={});var n=new Deferred(r);return getIdentity(function(r,t){r&&n.reject(r),e.identityName=t,n.resolve(new Runtime(e))}),n.promise}function getIdentity(e){function r(r){t(),e(null,r.name)}function n(r){t(),e(r)}function t(){u.removeListener("auth:success",r),u.removeListener("auth:Error",n)}var i="object"==typeof window;if(!i)return process.nextTick(e.bind(null,null));var o=require("postie"),u=new o(window);u.on("auth:success",r),u.on("auth:error",n),u.post("auth")}var Runtime=require("./runtime/runtime"),Deferred=require("./lib/deferred"),logLevels=require("./lib/vlog").levels,errors=require("./lib/verror");module.exports={init:init,logLevels:logLevels,errors:errors};
}).call(this,require("FWaASH"))
