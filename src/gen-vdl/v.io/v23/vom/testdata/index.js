...
},
{
  ...
  module.exports.CompatTests = canonicalize.reduce(new (vdl.Registry.lookupOrCreateConstructor(_type7))(new Map([
  ["bool", [
vdl.Types.BOOL,
_typeNBool,
_typeMBool,
...
canonicalize.reduce(new (vdl.Registry.lookupOrCreateConstructor(_type10))([
"A",
"B",
"C",
], true), _type10),
