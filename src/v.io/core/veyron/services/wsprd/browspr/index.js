...
var _typeblessingRoot = new vdl.Type();
...
_typeAssociateAccountMessage.name = "v.io/core/veyron/services/wsprd/browspr.AssociateAccountMessage";
_typeAssociateAccountMessage.fields = [{name: "Account", type: vdl.Types.STRING}, {name: "Origin", type: vdl.Types.STRING}, {name: "Caveats", type: _type2}];
_typeCleanupMessage.kind = vdl.Kind.STRUCT;
_typeCleanupMessage.name = "v.io/core/veyron/services/wsprd/browspr.CleanupMessage";
_typeCleanupMessage.fields = [{name: "InstanceId", type: vdl.Types.INT32}];
_typeCreateAccountMessage.kind = vdl.Kind.STRUCT;
_typeCreateAccountMessage.name = "v.io/core/veyron/services/wsprd/browspr.CreateAccountMessage";
_typeCreateAccountMessage.fields = [{name: "Token", type: vdl.Types.STRING}];
_typeGetAccountsMessage.kind = vdl.Kind.STRUCT;
_typeGetAccountsMessage.name = "v.io/core/veyron/services/wsprd/browspr.GetAccountsMessage";
_typeGetAccountsMessage.fields = [];
_typeOriginHasAccountMessage.kind = vdl.Kind.STRUCT;
_typeOriginHasAccountMessage.name = "v.io/core/veyron/services/wsprd/browspr.OriginHasAccountMessage";
_typeOriginHasAccountMessage.fields = [{name: "Origin", type: vdl.Types.STRING}];
_typeStartMessage.kind = vdl.Kind.STRUCT;
_typeStartMessage.name = "v.io/core/veyron/services/wsprd/browspr.StartMessage";
_typeStartMessage.fields = [{name: "Identityd", type: vdl.Types.STRING}, {name: "IdentitydBlessingRoot", type: _typeblessingRoot}, {name: "Proxy", type: vdl.Types.STRING}, {name: "NamespaceRoot", type: vdl.Types.STRING}, {name: "LogLevel", type: vdl.Types.INT32}, {name: "LogModule", type: vdl.Types.STRING}];
_typeblessingRoot.kind = vdl.Kind.STRUCT;
_typeblessingRoot.name = "v.io/core/veyron/services/wsprd/browspr.blessingRoot";
...
module.exports.blessingRoot = (vdl.Registry.lookupOrCreateConstructor(_typeblessingRoot));
