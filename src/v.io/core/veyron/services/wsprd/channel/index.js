...
_typeMessage.name = "v.io/core/veyron/services/wsprd/channel.Message";
_typeMessage.fields = [{name: "Request", type: _typeRequest}, {name: "Response", type: _typeResponse}];
_typeRequest.kind = vdl.Kind.STRUCT;
_typeRequest.name = "v.io/core/veyron/services/wsprd/channel.Request";
...
_typeResponse.name = "v.io/core/veyron/services/wsprd/channel.Response";
