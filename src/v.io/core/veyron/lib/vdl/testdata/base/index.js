...
_typeArgs.name = "v.io/core/veyron/lib/vdl/testdata/base.Args";
_typeArgs.fields = [{name: "A", type: vdl.Types.INT32}, {name: "B", type: vdl.Types.INT32}];
_typeCompComp.kind = vdl.Kind.STRUCT;
_typeCompComp.name = "v.io/core/veyron/lib/vdl/testdata/base.CompComp";
...
_typeComposites.name = "v.io/core/veyron/lib/vdl/testdata/base.Composites";
...
_typeCompositesArray.name = "v.io/core/veyron/lib/vdl/testdata/base.CompositesArray";
_typeCompositesArray.len = 2;
_typeCompositesArray.elem = _typeComposites;
_typeKeyScalars.kind = vdl.Kind.STRUCT;
_typeKeyScalars.name = "v.io/core/veyron/lib/vdl/testdata/base.KeyScalars";
...
_typeNamedArray.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedArray";
_typeNamedArray.len = 2;
_typeNamedArray.elem = vdl.Types.BOOL;
_typeNamedBool.kind = vdl.Kind.BOOL;
_typeNamedBool.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedBool";
_typeNamedByte.kind = vdl.Kind.BYTE;
_typeNamedByte.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedByte";
_typeNamedComplex128.kind = vdl.Kind.COMPLEX128;
_typeNamedComplex128.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedComplex128";
_typeNamedComplex64.kind = vdl.Kind.COMPLEX64;
_typeNamedComplex64.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedComplex64";
_typeNamedEnum.kind = vdl.Kind.ENUM;
_typeNamedEnum.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedEnum";
_typeNamedEnum.labels = ["A", "B", "C"];
_typeNamedFloat32.kind = vdl.Kind.FLOAT32;
_typeNamedFloat32.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedFloat32";
_typeNamedFloat64.kind = vdl.Kind.FLOAT64;
_typeNamedFloat64.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedFloat64";
_typeNamedInt16.kind = vdl.Kind.INT16;
_typeNamedInt16.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedInt16";
_typeNamedInt32.kind = vdl.Kind.INT32;
_typeNamedInt32.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedInt32";
_typeNamedInt64.kind = vdl.Kind.INT64;
_typeNamedInt64.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedInt64";
_typeNamedList.kind = vdl.Kind.LIST;
_typeNamedList.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedList";
_typeNamedList.elem = vdl.Types.UINT32;
_typeNamedMap.kind = vdl.Kind.MAP;
_typeNamedMap.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedMap";
_typeNamedMap.elem = vdl.Types.FLOAT32;
_typeNamedMap.key = vdl.Types.STRING;
_typeNamedSet.kind = vdl.Kind.SET;
_typeNamedSet.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedSet";
_typeNamedSet.key = vdl.Types.STRING;
_typeNamedString.kind = vdl.Kind.STRING;
_typeNamedString.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedString";
_typeNamedStruct.kind = vdl.Kind.STRUCT;
_typeNamedStruct.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedStruct";
...
_typeNamedUint16.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedUint16";
_typeNamedUint32.kind = vdl.Kind.UINT32;
_typeNamedUint32.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedUint32";
_typeNamedUint64.kind = vdl.Kind.UINT64;
_typeNamedUint64.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedUint64";
_typeNamedUnion.kind = vdl.Kind.UNION;
_typeNamedUnion.name = "v.io/core/veyron/lib/vdl/testdata/base.NamedUnion";
...
_typeNestedArgs.name = "v.io/core/veyron/lib/vdl/testdata/base.NestedArgs";
_typeNestedArgs.fields = [{name: "Args", type: _typeArgs}];
_typeScalars.kind = vdl.Kind.STRUCT;
_typeScalars.name = "v.io/core/veyron/lib/vdl/testdata/base.Scalars";
...
_typeScalarsArray.name = "v.io/core/veyron/lib/vdl/testdata/base.ScalarsArray";
...
module.exports.NoParams1Error = makeError('v.io/core/veyron/lib/vdl/testdata/base.NoParams1', actions.NO_RETRY, {
  'en': '{1:}{2:} en msg',
}, [
]);


module.exports.NoParams2Error = makeError('v.io/core/veyron/lib/vdl/testdata/base.NoParams2', actions.RETRY_REFETCH, {
  'en': '{1:}{2:} en msg',
  'fr': '{1:}{2:} fr msg',
}, [
]);
...
module.exports.WithParams1Error = makeError('v.io/core/veyron/lib/vdl/testdata/base.WithParams1', actions.NO_RETRY, {
  'en': '{1:}{2:} en x={3} y={4}',
}, [
  vdl.Types.STRING,
  vdl.Types.INT32,
...
module.exports.WithParams2Error = makeError('v.io/core/veyron/lib/vdl/testdata/base.WithParams2', actions.RETRY_REFETCH, {
  'en': '{1:}{2:} en x={3} y={4}',
  'fr': '{1:}{2:} fr y={4} x={3}',
}, [
  vdl.Types.STRING,
...
module.exports.notExportedError = makeError('v.io/core/veyron/lib/vdl/testdata/base.notExported', actions.NO_RETRY, {
  'en': '{1:}{2:} en x={3} y={4}',
}, [
  vdl.Types.STRING,
  vdl.Types.INT32,
