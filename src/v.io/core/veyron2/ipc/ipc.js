...
module.exports.UnknownMethodError = makeError('v.io/core/veyron2/ipc.UnknownMethod', actions.NO_RETRY, {
  'en': '{1:}{2:} unknown method {3}',
}, [
  vom.Types.STRING,
]);


module.exports.UnknownSuffixError = makeError('v.io/core/veyron2/ipc.UnknownSuffix', actions.NO_RETRY, {
  'en': '{1:}{2:} unknown object with suffix: {3}',
}, [
  vom.Types.STRING,
]);


module.exports.GlobNotImplementedError = makeError('v.io/core/veyron2/ipc.GlobNotImplemented', actions.NO_RETRY, {
  'en': '{1:}{2:} Glob not implemented by suffix: {3}',
}, [
  vom.Types.STRING,
]);
