...
var _type21 = new vom.Type();
var _type22 = new vom.Type();
var _type23 = new vom.Type();
var _type24 = new vom.Type();
...
_type10.kind = vom.Kind.MAP;
_type10.name = "";
_type10.elem = vom.Types.COMPLEX128;
_type10.key = vom.Types.STRING;
_type11.kind = vom.Kind.ARRAY;
_type11.name = "";
_type11.len = 2;
_type11.elem = _typeComposites;
_type12.kind = vom.Kind.LIST;
_type12.name = "";
_type12.elem = _typeComposites;
_type13.kind = vom.Kind.MAP;
_type13.name = "";
_type13.elem = _typeComposites;
_type13.key = vom.Types.STRING;
_type14.kind = vom.Kind.MAP;
_type14.name = "";
_type14.elem = _type15;
_type14.key = _typeKeyScalars;
_type15.kind = vom.Kind.LIST;
_type15.name = "";
_type15.elem = _type13;
_type16.kind = vom.Kind.ARRAY;
_type16.name = "";
_type16.len = 3;
_type16.elem = vom.Types.INT32;
_type17.kind = vom.Kind.LIST;
_type17.name = "";
_type17.elem = vom.Types.INT32;
_type18.kind = vom.Kind.SET;
_type18.name = "";
_type18.key = vom.Types.INT32;
_type19.kind = vom.Kind.MAP;
_type19.name = "";
_type19.elem = vom.Types.STRING;
_type19.key = vom.Types.INT32;
_type2.kind = vom.Kind.STRUCT;
_type2.name = "";
_type2.fields = [{name: "ID", type: vom.Types.STRING}, {name: "Action", type: vom.Types.UINT32}];
_type20.kind = vom.Kind.LIST;
_type20.name = "";
_type20.elem = vom.Types.BYTE;
_type21.kind = vom.Kind.ARRAY;
_type21.name = "";
_type21.len = 3;
_type21.elem = vom.Types.STRING;
_type22.kind = vom.Kind.LIST;
_type22.name = "";
_type22.elem = vom.Types.STRING;
_type23.kind = vom.Kind.SET;
_type23.name = "";
_type23.key = vom.Types.STRING;
_type24.kind = vom.Kind.MAP;
_type24.name = "";
_type24.elem = vom.Types.INT64;
_type24.key = vom.Types.STRING;
...
_type7.key = vom.Types.STRING;
_type8.kind = vom.Kind.MAP;
_type8.name = "";
_type8.elem = _type9;
...
_typeNamedUnion.kind = vom.Kind.ONEOF;
...
// Consts:
  ...
  module.exports.Carray = new (vom.Registry.lookupOrCreateConstructor(_type16))([
1,
2,
3,
]);

  module.exports.Clist = new (vom.Registry.lookupOrCreateConstructor(_type17))([
1,
2,
3,
]);

  module.exports.Cset = new (vom.Registry.lookupOrCreateConstructor(_type18))(new Set([
  1, ]));

  module.exports.Cmap = new (vom.Registry.lookupOrCreateConstructor(_type19))(new Map([
  [1, "A"]]));
