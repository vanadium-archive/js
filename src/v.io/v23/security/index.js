...
_type8.kind = vdl.Kind.ENUM;
_type8.name = "";
_type8.labels = ["NoRetry", "RetryConnection", "RetryRefetch", "RetryBackoff"];
...
_typeerror.fields = [{name: "Id", type: vdl.Types.STRING}, {name: "RetryCode", type: _type8}, {name: "Msg", type: vdl.Types.STRING}, {name: "ParamList", type: _type5}];
